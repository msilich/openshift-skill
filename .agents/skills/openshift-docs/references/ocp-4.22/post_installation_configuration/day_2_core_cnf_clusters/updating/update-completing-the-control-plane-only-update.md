...
- [Kubernetes API removals](../../../updating/preparing_for_updates/updating-cluster-prepare.md#kube-api-removals_updating-cluster-prepare)
...
- [Selecting the target release](update-api.md#update-selecting-the-target-release_update-api)
...
- [Preparing to update to OpenShift Container Platform 4.22](../../../updating/preparing_for_updates/updating-cluster-prepare.md#updating-cluster-prepare)
...
- [Monitoring the cluster update](update-completing-the-control-plane-only-update.md#update-monitoring-the-cluster-update_completing-the-update)
...
- [Updating the OLM Operators](update-completing-the-control-plane-only-update.md#update-updating-the-olm-operators_completing-the-update)
