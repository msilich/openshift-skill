...
- [Using RBAC to define and apply permissions](../../../authentication/using-rbac.md#authorization-overview_using-rbac)
...
- [Configuring an htpasswd identity provider](../../../authentication/identity_providers/configuring-htpasswd-identity-provider.md#identity-provider-htpasswd-about_configuring-htpasswd-identity-provider)
...
- [Upgrading an OpenShift cluster](../updating/update-welcome.md#update-welcome)
