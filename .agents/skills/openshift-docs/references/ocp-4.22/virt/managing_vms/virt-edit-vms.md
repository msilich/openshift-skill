...
<td style="text-align: left;"><p>Volume can be mounted as read only by many nodes.</p>
<div class="note">
<div class="title">
&#10;</div>
<p><code>ReadWriteMany</code> access mode is required for live migration.</p>
</div></td>
<td></td>
</tr>
</tbody>
...
- [Configuring shared volumes for virtual machines](virtual_disks/virt-configuring-shared-volumes-for-vms.md#virt-configuring-shared-volumes-for-vms)

- [Understanding config maps](../../nodes/pods/nodes-pods-configmaps.md#nodes-pods-configmap-overview_builds-configmaps)

- [Providing sensitive data to pods](../../nodes/pods/nodes-pods-secrets.md#nodes-pods-secrets-about)

- [Understanding and creating service accounts](../../authentication/understanding-and-creating-service-accounts.md#service-accounts-overview)
