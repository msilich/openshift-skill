...
- [Enabling or disabling virtual machine delete protection by using the web console](virt-enabling-disabling-vm-delete-protection.md#virt-enabling-disabling-vm-delete-protection-web_virt-enabling-disabling-vm-delete-protection)

- [Enabling or disabling virtual machine delete protection by using the CLI](virt-enabling-disabling-vm-delete-protection.md#virt-enabling-disabling-vm-delete-protection-cli_virt-enabling-disabling-vm-delete-protection)
