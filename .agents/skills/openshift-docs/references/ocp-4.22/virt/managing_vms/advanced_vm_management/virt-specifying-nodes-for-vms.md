...
- [Specifying nodes for virtualization components](../../post_installation_configuration/virt-node-placement-virt-components.md#virt-node-placement-virt-components)
...
- [Controlling pod placement on nodes using node affinity rules](../../../nodes/scheduling/nodes-scheduler-node-affinity.md#nodes-scheduler-node-affinity)
