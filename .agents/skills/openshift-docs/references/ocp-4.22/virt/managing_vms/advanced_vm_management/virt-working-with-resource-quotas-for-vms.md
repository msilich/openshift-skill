...
- The Application Aware Quota operator is enabled in your cluster. See [Enabling the Application Aware Quota operator](#virt-enabling-aaq-operator_virt-working-with-resource-quotas-for-vms).
...
4.  To edit a quota, click the Options menu ![kebab](data:image/png;base64,) at the end of the quota row
...
5.  To delete a quota, click the Options menu ![kebab](data:image/png;base64,) at the end of the quota row and select **Delete quota**. A confirmation dialog is displayed.
...
- [Resource quotas per project](../../../applications/quotas/quotas-setting-per-project.md#quotas-setting-per-project)

- [Resource quotas across many projects](../../../applications/quotas/quotas-setting-across-multiple-projects.md#quotas-setting-across-multiple-projects)

- [Understanding the Application Aware Quota operator](virt-working-with-resource-quotas-for-vms.md#virt-understanding-aaq-operator_virt-working-with-resource-quotas-for-vms)

- [Enabling the Application Aware Quota operator](virt-working-with-resource-quotas-for-vms.md#virt-enabling-aaq-operator_virt-working-with-resource-quotas-for-vms)

- [Creating virtual machine quotas using the web console](virt-working-with-resource-quotas-for-vms.md#virt-creating-vm-quotas-web_virt-working-with-resource-quotas-for-vms)

- [Managing virtual machine quotas using the list view](virt-working-with-resource-quotas-for-vms.md#virt-managing-quotas-list-web_virt-working-with-resource-quotas-for-vms)

- [Managing virtual machine quota details using the web console](virt-working-with-resource-quotas-for-vms.md#virt-managing-quota-details-web_virt-working-with-resource-quotas-for-vms)
