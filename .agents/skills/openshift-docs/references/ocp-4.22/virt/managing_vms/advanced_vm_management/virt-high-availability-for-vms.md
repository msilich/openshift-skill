...
- [Delete a failed node to trigger virtual machine failover](../../nodes/virt-eviction-strategies.md#virt-delete-failed-node-vm-failover_virt-eviction-strategies)
