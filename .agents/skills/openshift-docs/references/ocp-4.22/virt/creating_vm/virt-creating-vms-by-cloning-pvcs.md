...
- [Setting a default cloning strategy using a storage profile](../storage/virt-configuring-storage-profile.md#virt-customizing-storage-profile-default-cloning-strategy_virt-configuring-storage-profile)
