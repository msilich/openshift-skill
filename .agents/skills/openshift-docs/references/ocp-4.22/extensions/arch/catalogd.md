...
- [File-based catalogs](../catalogs/fbc.md#fbc)

- [Adding a catalog to a cluster](../catalogs/managing-catalogs.md#olmv1-adding-a-catalog-to-a-cluster_managing-catalogs)

- [Red Hat-provided catalogs](../catalogs/rh-catalogs.md#rh-catalogs)
