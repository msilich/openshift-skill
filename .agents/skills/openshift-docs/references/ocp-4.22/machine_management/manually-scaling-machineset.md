...
- [Modifying a compute machine set](modifying-machineset.md#modifying-machineset)

- [Add the compute machines to the Proxy object’s `noProxy` field](../networking/configuring_network_settings/enable-cluster-wide-proxy.md#nw-proxy-configure-object_config-cluster-wide-proxy)
