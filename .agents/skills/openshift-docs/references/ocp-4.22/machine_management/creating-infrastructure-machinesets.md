...
- [Machine sets that deploy machines as preemptible VM instances](creating_machinesets/creating-machineset-gcp.md#machineset-non-guaranteed-instance_legacy-preempt)
