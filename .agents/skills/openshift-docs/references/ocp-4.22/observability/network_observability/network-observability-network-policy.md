...
- [Creating a network policy using the CLI](../../networking/network_security/network_policy/creating-network-policy.md#nw-networkpolicy-object_creating-network-policy)
