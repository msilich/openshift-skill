...
- [Configuring a local arbiter node with installer-provisioned infrastructure](../installing_bare_metal/ipi/ipi-install-installation-workflow.md#ipi-install-config-local-arbiter-node_ipi-install-installation-workflow)
...
- [Configuring a local arbiter node with user-provisioned infrastructure](../installing_bare_metal/upi/installing-bare-metal.md#upi-install-config-local-arbiter-node_installing-bare-metal)
