...
<div class="title">
&#10;</div>
<p>OpenShift Container Platform 4.22 supports hardware RAID on the installation drive for BMCs, including:</p>
<ul>
...
<p>OpenShift Container Platform 4.22 does not support software RAID on the installation drive.</p>
</div>
