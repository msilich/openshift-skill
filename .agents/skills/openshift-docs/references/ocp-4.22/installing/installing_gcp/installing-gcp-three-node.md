...
- [Installing a cluster on user-provisioned infrastructure in Google Cloud by using Infrastructure Manager templates](installing-gcp-user-infra.md#installing-gcp-user-infra)
