...
- [Reducing permissions while using the Google Cloud CSI Driver Operator](../../storage/container_storage_interface/persistent-storage-csi-gcp-pd.md#persistent-storage-csi-gcp-pd-reduce-permissions_persistent-storage-csi-gcp-pd)
...
# Configuring Google Cloud organization policies and VPC service controls
...
- [Installing a cluster quickly on Google Cloud](installing-gcp-default.md#installing-gcp-default)
