...
- [About BGP routing](about-bgp-routing.md#about-bgp-routing)

- [Enabling BGP routing](enabling-bgp-routing.md#enabling-bgp-routing)
...
- [Best practices for ClusterUserDefinedNetwork CRs](../../multiple_networks/primary_networks/about-user-defined-networks.md#considerations-for-cudn_user-defined-networks)
