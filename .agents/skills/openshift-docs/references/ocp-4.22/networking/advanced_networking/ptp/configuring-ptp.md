...
- [Boundary clocks without holdover on Intel Granite Rapids-D hardware](configuring-ptp.md#nw-ptp-granite-rapids-boundary-clock-overview_configuring-ptp)

- [Configuring linuxptp services as a boundary clock without holdover on Intel Granite Rapids-D hardware](configuring-ptp.md#ptp-configuring-linuxptp-services-as-boundary-clock-gnrd_configuring-ptp)

- [Configuring GNR-D T-BC holdover on a GNR-D platform](configuring-ptp.md#nw-ptp-gnrd-t-bc-holdover_configuring-ptp)
...
- [Configuring the PTP fast event notifications publisher](ptp-cloud-events-consumer-dev-reference-v2.md#cnf-configuring-the-ptp-fast-event-publisher-v2_ptp-consumer)
...
- [Grandmaster clock class sync state reference](configuring-ptp.md#nw-ptp-grandmaster-clock-class-reference_configuring-ptp)
...
- [Machine Configuration documentation](../../../machine_configuration/index.md#machine-config-index)
...
- [Configuring FIFO priority scheduling for PTP hardware](configuring-ptp.md#cnf-configuring-fifo-priority-scheduling-for-ptp_configuring-ptp)
...
- [Using dual-port NICs to improve redundancy for PTP ordinary clocks](about-ptp.md#ptp-dual-ports-oc_about-ptp)
