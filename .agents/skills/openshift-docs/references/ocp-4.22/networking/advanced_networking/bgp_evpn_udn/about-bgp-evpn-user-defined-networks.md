...
| Services (NodePort, External IP, LoadBalancer) | Limited<sup>\[1\]</sup> |
...
- [About BGP routing](../bgp_routing/about-bgp-routing.md#about-bgp-routing)

- [About route advertisements](../route_advertisements/about-route-advertisements.md#about-route-advertisements)

- [Enabling route advertisements](../route_advertisements/enabling-route-advertisements.md#nw-route-advertisements-enable_enabling-route-advertisements)

- [Configuring a gateway](../../ovn_kubernetes_network_provider/configuring-gateway.md#configuring-gateway)

- [Managing the NodeNetworkConfigurationPolicy manifest file](../../k8s_nmstate/k8s-nmstate-updating-node-network-config.md#virt-manage-nncp-cli_k8s-nmstate-updating-node-network-config)
...
- [ClusterUserDefinedNetwork k8s.ovn.org/v1](../../../rest_api/network_apis/clusteruserdefinednetwork-k8s-ovn-org-v1.md#specifications)
