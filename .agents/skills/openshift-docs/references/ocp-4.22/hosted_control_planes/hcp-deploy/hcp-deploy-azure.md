...
- [Creating Azure Workload Identities](hcp-deploy-azure.md#hcp-azure-workload-id_hcp-deploy-azure)
...
- [Configuring an Azure management cluster for hosted control planes](hcp-deploy-azure.md#hcp-azure-mgmt-cluster_hcp-deploy-azure)

- [Setting up an OIDC issuer](hcp-deploy-azure.md#hcp-azure-oidc_hcp-deploy-azure)
...
- [Preparing a subnet for a private hosted cluster on Azure](hcp-deploy-azure.md#hcp-azure-private-subnet_hcp-deploy-azure)

- [Installing the HyperShift Operator with private platform support](hcp-deploy-azure.md#hcp-azure-private-operator_hcp-deploy-azure)

- [Configuring IAM resources for a private hosted cluster](hcp-deploy-azure.md#hcp-azure-private-iam_hcp-deploy-azure)

- [Creating infrastructure for a private hosted cluster](hcp-deploy-azure.md#hcp-azure-private-infra_hcp-deploy-azure)
...
- [Creating a private Azure hosted cluster](hcp-deploy-azure.md#hcp-azure-private-hosted_hcp-deploy-azure)
...
# Example: Autoscaling a hosted cluster on Azure
