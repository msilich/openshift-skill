...
# Additional ports for node pools
...
# Node tuning for hosted clusters on RHOSP
...
- [Installing the SR-IOV Network Operator](../../networking/networking_operators/sr-iov-operator/installing-sriov-operator.md#installing-sr-iov-operator_installing-sriov-operator)
