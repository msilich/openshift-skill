...
- [Installing the hosted control planes command-line interface](hcp-prepare/hcp-cli.md#hcp-cli)
...
- [Connectivity monitoring for hosted control planes](hcp-observability.md#hcp-connectivity-metrics_hcp-observability)
