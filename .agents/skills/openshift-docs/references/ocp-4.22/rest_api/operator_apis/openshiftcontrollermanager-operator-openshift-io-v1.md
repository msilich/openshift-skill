...
| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`OpenShiftControllerManagerList`](../objects/index.md#io-openshift-operator-v1-OpenShiftControllerManagerList) schema |
| 401 - Unauthorized | Empty |
...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`OpenShiftControllerManager`](openshiftcontrollermanager-operator-openshift-io-v1.md#openshiftcontrollermanager-operator-openshift-io-v1) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`OpenShiftControllerManager`](openshiftcontrollermanager-operator-openshift-io-v1.md#openshiftcontrollermanager-operator-openshift-io-v1) schema |
| 201 - Created | [`OpenShiftControllerManager`](openshiftcontrollermanager-operator-openshift-io-v1.md#openshiftcontrollermanager-operator-openshift-io-v1) schema |
| 202 - Accepted | [`OpenShiftControllerManager`](openshiftcontrollermanager-operator-openshift-io-v1.md#openshiftcontrollermanager-operator-openshift-io-v1) schema |
| 401 - Unauthorized | Empty |
