...
| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`OpenShiftAPIServerList`](../objects/index.md#io-openshift-operator-v1-OpenShiftAPIServerList) schema |
| 401 - Unauthorized | Empty |
...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`OpenShiftAPIServer`](openshiftapiserver-operator-openshift-io-v1.md#openshiftapiserver-operator-openshift-io-v1) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`OpenShiftAPIServer`](openshiftapiserver-operator-openshift-io-v1.md#openshiftapiserver-operator-openshift-io-v1) schema |
| 201 - Created | [`OpenShiftAPIServer`](openshiftapiserver-operator-openshift-io-v1.md#openshiftapiserver-operator-openshift-io-v1) schema |
| 202 - Accepted | [`OpenShiftAPIServer`](openshiftapiserver-operator-openshift-io-v1.md#openshiftapiserver-operator-openshift-io-v1) schema |
| 401 - Unauthorized | Empty |
