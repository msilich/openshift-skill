...
<tbody>
<tr>
<td style="text-align: left;"><p><code>bootImageSkewEnforcement</code></p></td>
<td style="text-align: left;"><p><code>object</code></p></td>
<td style="text-align: left;"><p>bootImageSkewEnforcement allows an admin to configure how boot image version skew is enforced on the cluster. When omitted, this will default to Automatic for clusters that support automatic boot image updates. For clusters that do not support automatic boot image updates, cluster upgrades will be disabled until a skew enforcement mode has been specified. When version skew is being enforced, cluster upgrades will be disabled until the version skew is deemed acceptable for the current release payload.</p></td>
</tr>
<tr>
...
| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`MachineConfigurationList`](../objects/index.md#io-openshift-operator-v1-MachineConfigurationList) schema |
| 401 - Unauthorized | Empty |
...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`MachineConfiguration`](machineconfiguration-operator-openshift-io-v1.md#machineconfiguration-operator-openshift-io-v1) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`MachineConfiguration`](machineconfiguration-operator-openshift-io-v1.md#machineconfiguration-operator-openshift-io-v1) schema |
| 201 - Created | [`MachineConfiguration`](machineconfiguration-operator-openshift-io-v1.md#machineconfiguration-operator-openshift-io-v1) schema |
| 202 - Accepted | [`MachineConfiguration`](machineconfiguration-operator-openshift-io-v1.md#machineconfiguration-operator-openshift-io-v1) schema |
| 401 - Unauthorized | Empty |
