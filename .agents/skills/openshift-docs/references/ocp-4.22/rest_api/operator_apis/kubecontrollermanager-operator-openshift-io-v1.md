...
| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`KubeControllerManagerList`](../objects/index.md#io-openshift-operator-v1-KubeControllerManagerList) schema |
| 401 - Unauthorized | Empty |
...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`KubeControllerManager`](kubecontrollermanager-operator-openshift-io-v1.md#kubecontrollermanager-operator-openshift-io-v1) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`KubeControllerManager`](kubecontrollermanager-operator-openshift-io-v1.md#kubecontrollermanager-operator-openshift-io-v1) schema |
| 201 - Created | [`KubeControllerManager`](kubecontrollermanager-operator-openshift-io-v1.md#kubecontrollermanager-operator-openshift-io-v1) schema |
| 202 - Accepted | [`KubeControllerManager`](kubecontrollermanager-operator-openshift-io-v1.md#kubecontrollermanager-operator-openshift-io-v1) schema |
| 401 - Unauthorized | Empty |
