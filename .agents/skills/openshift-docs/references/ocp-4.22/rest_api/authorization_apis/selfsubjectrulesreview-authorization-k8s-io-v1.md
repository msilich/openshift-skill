...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`SelfSubjectRulesReview`](selfsubjectrulesreview-authorization-k8s-io-v1.md#selfsubjectrulesreview-authorization-k8s-io-v1) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`SelfSubjectRulesReview`](selfsubjectrulesreview-authorization-k8s-io-v1.md#selfsubjectrulesreview-authorization-k8s-io-v1) schema |
| 201 - Created | [`SelfSubjectRulesReview`](selfsubjectrulesreview-authorization-k8s-io-v1.md#selfsubjectrulesreview-authorization-k8s-io-v1) schema |
| 202 - Accepted | [`SelfSubjectRulesReview`](selfsubjectrulesreview-authorization-k8s-io-v1.md#selfsubjectrulesreview-authorization-k8s-io-v1) schema |
