...
| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`OperatorList`](../objects/index.md#com-coreos-operators-v1-OperatorList) schema |
| 401 - Unauthorized | Empty |
...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`Operator`](operator-operators-coreos-com-v1.md#operator-operators-coreos-com-v1) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`Operator`](operator-operators-coreos-com-v1.md#operator-operators-coreos-com-v1) schema |
| 201 - Created | [`Operator`](operator-operators-coreos-com-v1.md#operator-operators-coreos-com-v1) schema |
| 202 - Accepted | [`Operator`](operator-operators-coreos-com-v1.md#operator-operators-coreos-com-v1) schema |
| 401 - Unauthorized | Empty |
