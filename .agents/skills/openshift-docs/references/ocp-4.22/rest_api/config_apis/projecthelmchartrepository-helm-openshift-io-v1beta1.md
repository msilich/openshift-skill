...
|----|----|
| 200 - OK | [`ProjectHelmChartRepositoryList`](../objects/index.md#io-openshift-helm-v1beta1-ProjectHelmChartRepositoryList) schema |
...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`ProjectHelmChartRepository`](projecthelmchartrepository-helm-openshift-io-v1beta1.md#projecthelmchartrepository-helm-openshift-io-v1beta1) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`ProjectHelmChartRepository`](projecthelmchartrepository-helm-openshift-io-v1beta1.md#projecthelmchartrepository-helm-openshift-io-v1beta1) schema |
| 201 - Created | [`ProjectHelmChartRepository`](projecthelmchartrepository-helm-openshift-io-v1beta1.md#projecthelmchartrepository-helm-openshift-io-v1beta1) schema |
| 202 - Accepted | [`ProjectHelmChartRepository`](projecthelmchartrepository-helm-openshift-io-v1beta1.md#projecthelmchartrepository-helm-openshift-io-v1beta1) schema |
| 401 - Unauthorized | Empty |
