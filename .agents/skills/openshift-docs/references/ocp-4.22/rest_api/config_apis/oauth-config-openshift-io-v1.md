...
| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`OAuthList`](../objects/index.md#io-openshift-config-v1-OAuthList) schema |
| 401 - Unauthorized | Empty |
...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`OAuth`](oauth-config-openshift-io-v1.md#oauth-config-openshift-io-v1) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`OAuth`](oauth-config-openshift-io-v1.md#oauth-config-openshift-io-v1) schema |
| 201 - Created | [`OAuth`](oauth-config-openshift-io-v1.md#oauth-config-openshift-io-v1) schema |
| 202 - Accepted | [`OAuth`](oauth-config-openshift-io-v1.md#oauth-config-openshift-io-v1) schema |
| 401 - Unauthorized | Empty |
