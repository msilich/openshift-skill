...
| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`NodeList`](../objects/index.md#io-openshift-config-v1-NodeList) schema |
| 401 - Unauthorized | Empty |
...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`Node`](node-config-openshift-io-v1.md#node-config-openshift-io-v1) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`Node`](node-config-openshift-io-v1.md#node-config-openshift-io-v1) schema |
| 201 - Created | [`Node`](node-config-openshift-io-v1.md#node-config-openshift-io-v1) schema |
| 202 - Accepted | [`Node`](node-config-openshift-io-v1.md#node-config-openshift-io-v1) schema |
| 401 - Unauthorized | Empty |
