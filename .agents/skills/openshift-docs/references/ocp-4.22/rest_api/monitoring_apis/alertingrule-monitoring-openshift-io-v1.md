...
| Property | Type     | Description                            |
|----------|----------|----------------------------------------|
| `name`   | `string` | name of the referenced PrometheusRule. |
...
|----|----|
| 200 - OK | [`AlertingRuleList`](../objects/index.md#io-openshift-monitoring-v1-AlertingRuleList) schema |
...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`AlertingRule`](alertingrule-monitoring-openshift-io-v1.md#alertingrule-monitoring-openshift-io-v1) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`AlertingRule`](alertingrule-monitoring-openshift-io-v1.md#alertingrule-monitoring-openshift-io-v1) schema |
| 201 - Created | [`AlertingRule`](alertingrule-monitoring-openshift-io-v1.md#alertingrule-monitoring-openshift-io-v1) schema |
| 202 - Accepted | [`AlertingRule`](alertingrule-monitoring-openshift-io-v1.md#alertingrule-monitoring-openshift-io-v1) schema |
| 401 - Unauthorized | Empty |
...
| Parameter | Type     | Description              |
|-----------|----------|--------------------------|
| `name`    | `string` | name of the AlertingRule |
