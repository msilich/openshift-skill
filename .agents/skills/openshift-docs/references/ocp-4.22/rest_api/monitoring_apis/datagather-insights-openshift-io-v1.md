...
| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`DataGatherList`](../objects/index.md#io-openshift-insights-v1-DataGatherList) schema |
| 401 - Unauthorized | Empty |
...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`DataGather`](datagather-insights-openshift-io-v1.md#datagather-insights-openshift-io-v1) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`DataGather`](datagather-insights-openshift-io-v1.md#datagather-insights-openshift-io-v1) schema |
| 201 - Created | [`DataGather`](datagather-insights-openshift-io-v1.md#datagather-insights-openshift-io-v1) schema |
| 202 - Accepted | [`DataGather`](datagather-insights-openshift-io-v1.md#datagather-insights-openshift-io-v1) schema |
| 401 - Unauthorized | Empty |
