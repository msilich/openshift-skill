...
<p>Bigger numbers mean a larger nominal concurrency limit, at the expense of every other priority level. This field has a default value of zero.</p></td>
</tr>
</tbody>
</table>
...
<p>Setting this field to zero supports the construction of a "jail" for this priority level that is used to hold some request(s)</p></td>
</tr>
</tbody>
</table>
...
| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`PriorityLevelConfigurationList`](../objects/index.md#io-k8s-api-flowcontrol-v1-PriorityLevelConfigurationList) schema |
| 401 - Unauthorized | Empty |
...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`PriorityLevelConfiguration`](prioritylevelconfiguration-flowcontrol-apiserver-k8s-io-v1.md#prioritylevelconfiguration-flowcontrol-apiserver-k8s-io-v1) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`PriorityLevelConfiguration`](prioritylevelconfiguration-flowcontrol-apiserver-k8s-io-v1.md#prioritylevelconfiguration-flowcontrol-apiserver-k8s-io-v1) schema |
| 201 - Created | [`PriorityLevelConfiguration`](prioritylevelconfiguration-flowcontrol-apiserver-k8s-io-v1.md#prioritylevelconfiguration-flowcontrol-apiserver-k8s-io-v1) schema |
| 202 - Accepted | [`PriorityLevelConfiguration`](prioritylevelconfiguration-flowcontrol-apiserver-k8s-io-v1.md#prioritylevelconfiguration-flowcontrol-apiserver-k8s-io-v1) schema |
| 401 - Unauthorized | Empty |
