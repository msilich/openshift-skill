...
| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`ContainerRuntimeConfigList`](../objects/index.md#io-openshift-machineconfiguration-v1-ContainerRuntimeConfigList) schema |
| 401 - Unauthorized | Empty |
...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`ContainerRuntimeConfig`](containerruntimeconfig-machineconfiguration-openshift-io-v1.md#containerruntimeconfig-machineconfiguration-openshift-io-v1) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`ContainerRuntimeConfig`](containerruntimeconfig-machineconfiguration-openshift-io-v1.md#containerruntimeconfig-machineconfiguration-openshift-io-v1) schema |
| 201 - Created | [`ContainerRuntimeConfig`](containerruntimeconfig-machineconfiguration-openshift-io-v1.md#containerruntimeconfig-machineconfiguration-openshift-io-v1) schema |
| 202 - Accepted | [`ContainerRuntimeConfig`](containerruntimeconfig-machineconfiguration-openshift-io-v1.md#containerruntimeconfig-machineconfiguration-openshift-io-v1) schema |
| 401 - Unauthorized | Empty |
