...
| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`MachineOSBuildList`](../objects/index.md#io-openshift-machineconfiguration-v1-MachineOSBuildList) schema |
| 401 - Unauthorized | Empty |
...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`MachineOSBuild`](machineosbuild-machineconfiguration-openshift-io-v1.md#machineosbuild-machineconfiguration-openshift-io-v1) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`MachineOSBuild`](machineosbuild-machineconfiguration-openshift-io-v1.md#machineosbuild-machineconfiguration-openshift-io-v1) schema |
| 201 - Created | [`MachineOSBuild`](machineosbuild-machineconfiguration-openshift-io-v1.md#machineosbuild-machineconfiguration-openshift-io-v1) schema |
| 202 - Accepted | [`MachineOSBuild`](machineosbuild-machineconfiguration-openshift-io-v1.md#machineosbuild-machineconfiguration-openshift-io-v1) schema |
| 401 - Unauthorized | Empty |
