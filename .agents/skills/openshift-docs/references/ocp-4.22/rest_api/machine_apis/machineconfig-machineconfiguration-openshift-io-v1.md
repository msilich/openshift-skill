...
| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`MachineConfigList`](../objects/index.md#io-openshift-machineconfiguration-v1-MachineConfigList) schema |
| 401 - Unauthorized | Empty |
...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`MachineConfig`](machineconfig-machineconfiguration-openshift-io-v1.md#machineconfig-machineconfiguration-openshift-io-v1) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`MachineConfig`](machineconfig-machineconfiguration-openshift-io-v1.md#machineconfig-machineconfiguration-openshift-io-v1) schema |
| 201 - Created | [`MachineConfig`](machineconfig-machineconfiguration-openshift-io-v1.md#machineconfig-machineconfiguration-openshift-io-v1) schema |
| 202 - Accepted | [`MachineConfig`](machineconfig-machineconfiguration-openshift-io-v1.md#machineconfig-machineconfiguration-openshift-io-v1) schema |
| 401 - Unauthorized | Empty |
