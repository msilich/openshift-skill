...
| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`MachineConfigPoolList`](../objects/index.md#io-openshift-machineconfiguration-v1-MachineConfigPoolList) schema |
| 401 - Unauthorized | Empty |
...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`MachineConfigPool`](machineconfigpool-machineconfiguration-openshift-io-v1.md#machineconfigpool-machineconfiguration-openshift-io-v1) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`MachineConfigPool`](machineconfigpool-machineconfiguration-openshift-io-v1.md#machineconfigpool-machineconfiguration-openshift-io-v1) schema |
| 201 - Created | [`MachineConfigPool`](machineconfigpool-machineconfiguration-openshift-io-v1.md#machineconfigpool-machineconfiguration-openshift-io-v1) schema |
| 202 - Accepted | [`MachineConfigPool`](machineconfigpool-machineconfiguration-openshift-io-v1.md#machineconfigpool-machineconfiguration-openshift-io-v1) schema |
| 401 - Unauthorized | Empty |
