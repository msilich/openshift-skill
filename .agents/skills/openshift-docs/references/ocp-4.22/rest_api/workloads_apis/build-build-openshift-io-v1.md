...
| Property | Type | Description |
|----|----|----|
| `fromRef` | [`ObjectReference`](../objects/index.md#io-k8s-api-core-v1-ObjectReference) | fromRef contains detailed information about an image that triggered a build. |
...
| `completionTimestamp` | [`Time`](../objects/index.md#io-k8s-apimachinery-pkg-apis-meta-v1-Time) | completionTimestamp is a timestamp representing the server time when this Build was finished, whether that build failed or succeeded. It reflects the time at which the Pod running the Build terminated. It is represented in RFC3339 form and is in UTC. |
...
| `config` | [`ObjectReference`](../objects/index.md#io-k8s-api-core-v1-ObjectReference) | config is an ObjectReference to the BuildConfig this Build is based on. |
...
| `startTimestamp` | [`Time`](../objects/index.md#io-k8s-apimachinery-pkg-apis-meta-v1-Time) | startTimestamp is a timestamp representing the server time when this Build started running in a Pod. It is represented in RFC3339 form and is in UTC. |
...
| Property | Type | Description |
|----|----|----|
| `lastTransitionTime` | [`Time`](../objects/index.md#io-k8s-apimachinery-pkg-apis-meta-v1-Time) | The last time the condition transitioned from one status to another. |
| `lastUpdateTime` | [`Time`](../objects/index.md#io-k8s-apimachinery-pkg-apis-meta-v1-Time) | The last time this condition was updated. |
...
<p>Please note that this field may not always be set even if the push completes successfully - e.g. when the registry returns no digest or returns it in a format that the builder doesn’t understand.</p></td>
</tr>
</tbody>
</table>
...
| `startTime` | [`Time`](../objects/index.md#io-k8s-apimachinery-pkg-apis-meta-v1-Time) | startTime is a timestamp representing the server time when this Stage started. It is represented in RFC3339 form and is in UTC. |
...
| `startTime` | [`Time`](../objects/index.md#io-k8s-apimachinery-pkg-apis-meta-v1-Time) | startTime is a timestamp representing the server time when this Step started. it is represented in RFC3339 form and is in UTC. |
...
|----|----|
| 200 - OK | [`BuildList`](../objects/index.md#com-github-openshift-api-build-v1-BuildList) schema |
...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`Build`](build-build-openshift-io-v1.md#build-build-openshift-io-v1) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`Build`](build-build-openshift-io-v1.md#build-build-openshift-io-v1) schema |
| 201 - Created | [`Build`](build-build-openshift-io-v1.md#build-build-openshift-io-v1) schema |
| 202 - Accepted | [`Build`](build-build-openshift-io-v1.md#build-build-openshift-io-v1) schema |
| 401 - Unauthorized | Empty |
