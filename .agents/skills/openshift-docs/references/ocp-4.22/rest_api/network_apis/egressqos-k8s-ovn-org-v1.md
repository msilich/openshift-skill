...
<td style="text-align: left;"><p>An array of condition objects indicating details about status of EgressQoS object.</p></td>
</tr>
<tr>
<td style="text-align: left;"><p><code>conditions[]</code></p></td>
...
<td style="text-align: left;"><p>A concise indication of whether the EgressQoS resource is applied with success.</p></td>
</tr>
</tbody>
</table>
...
|----|----|
| 200 - OK | [`EgressQoSList`](../objects/index.md#org-ovn-k8s-v1-EgressQoSList) schema |
...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`EgressQoS`](egressqos-k8s-ovn-org-v1.md#egressqos-k8s-ovn-org-v1) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`EgressQoS`](egressqos-k8s-ovn-org-v1.md#egressqos-k8s-ovn-org-v1) schema |
| 201 - Created | [`EgressQoS`](egressqos-k8s-ovn-org-v1.md#egressqos-k8s-ovn-org-v1) schema |
| 202 - Accepted | [`EgressQoS`](egressqos-k8s-ovn-org-v1.md#egressqos-k8s-ovn-org-v1) schema |
| 401 - Unauthorized | Empty |
