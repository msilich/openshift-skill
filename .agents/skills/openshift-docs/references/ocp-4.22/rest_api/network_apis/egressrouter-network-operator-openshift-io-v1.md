...
|----|----|
| 200 - OK | [`EgressRouterList`](../objects/index.md#io-openshift-operator-network-v1-EgressRouterList) schema |
...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`EgressRouter`](egressrouter-network-operator-openshift-io-v1.md#egressrouter-network-operator-openshift-io-v1) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`EgressRouter`](egressrouter-network-operator-openshift-io-v1.md#egressrouter-network-operator-openshift-io-v1) schema |
| 201 - Created | [`EgressRouter`](egressrouter-network-operator-openshift-io-v1.md#egressrouter-network-operator-openshift-io-v1) schema |
| 202 - Accepted | [`EgressRouter`](egressrouter-network-operator-openshift-io-v1.md#egressrouter-network-operator-openshift-io-v1) schema |
| 401 - Unauthorized | Empty |
