...
|----|----|
| 200 - OK | [`NetworkAttachmentDefinitionList`](../objects/index.md#io-cncf-cni-k8s-v1-NetworkAttachmentDefinitionList) schema |
...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`NetworkAttachmentDefinition`](networkattachmentdefinition-k8s-cni-cncf-io-v1.md#networkattachmentdefinition-k8s-cni-cncf-io-v1) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`NetworkAttachmentDefinition`](networkattachmentdefinition-k8s-cni-cncf-io-v1.md#networkattachmentdefinition-k8s-cni-cncf-io-v1) schema |
| 201 - Created | [`NetworkAttachmentDefinition`](networkattachmentdefinition-k8s-cni-cncf-io-v1.md#networkattachmentdefinition-k8s-cni-cncf-io-v1) schema |
| 202 - Accepted | [`NetworkAttachmentDefinition`](networkattachmentdefinition-k8s-cni-cncf-io-v1.md#networkattachmentdefinition-k8s-cni-cncf-io-v1) schema |
| 401 - Unauthorized | Empty |
