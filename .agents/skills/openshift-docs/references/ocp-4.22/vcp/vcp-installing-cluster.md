...
# Deploying a virtualized control plane with GitOps ZTP
...
- [Preparing to install with the agent-based installer](../installing/installing_with_agent_based_installer/preparing-to-install-with-agent-based-installer.md#preparing-to-install-with-agent-based-installer)

- [Installation configuration parameters for the agent-based installer](../installing/installing_with_agent_based_installer/installation-config-parameters-agent.md#installation-config-parameters-agent)

- [Installation configuration parameters for bare metal](../installing/installing_bare_metal/upi/installation-config-parameters-bare-metal.md#installation-config-parameters-bare-metal)

- [Deploying far edge sites with ZTP](../edge_computing/ztp-deploying-far-edge-sites.md#ztp-deploying-far-edge-sites)

- [BMC addressing for installer-provisioned infrastructure](../installing/installing_bare_metal/ipi/ipi-install-installation-workflow.md#bmc-addressing_ipi-install-installation-workflow)

- [Configuring KubeVirt Redfish for VM management](../virt/post_installation_configuration/virt-kubevirt-redfish.md#virt-kubevirt-redfish)

- [Preparing the provisioner node for OpenShift Container Platform installation](../installing/installing_bare_metal/ipi/ipi-install-installation-workflow.md#preparing-the-provisioner-node-for-openshift-install_ipi-install-installation-workflow)
