...
- [Prerequisites for virtualized control planes](vcp-prerequisites.md#vcp-prerequisites)

- [Installing KubeVirt Redfish](../virt/post_installation_configuration/virt-kubevirt-redfish.md#proc_virt-installing-kubevirt-redfish_virt-kubevirt-redfish)
