...
- [Recommended resources for the agent-based installer](../installing/installing_with_agent_based_installer/preparing-to-install-with-agent-based-installer.md#agent-based-installer-recommended-resources_preparing-to-install-with-agent-based-installer)

- [Effects of disk latency on etcd](../etcd/etcd-performance.md#etcd-disk-latency_etcd-performance)
