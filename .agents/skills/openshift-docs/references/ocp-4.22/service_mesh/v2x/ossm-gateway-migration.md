...
- [Enabling gateway injection](ossm-traffic-manage.md#ossm-automatic-gateway-injection_traffic-management)

- [Deploying automatic gateway injection](ossm-traffic-manage.md#ossm-deploying-automatic-gateway-injection_traffic-management)
