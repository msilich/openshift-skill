...
- For more information about tuning Service Mesh for performance, see [Performance and scalability](ossm-performance-scalability.md#ossm-performance-scalability).
