...
The cluster queue is not ready for use until a [`ResourceFlavor` object](configuring-quotas.md#configuring-resourceflavors_configuring-quotas) has also been configured.
...
- [RBAC permissions](rbac-permissions.md#rbac-permissions)
