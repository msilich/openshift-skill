...
- See [Replacing the default ingress certificate](../security/certificates/replacing-default-ingress-certificate.md#replacing-default-ingress) for more information.
