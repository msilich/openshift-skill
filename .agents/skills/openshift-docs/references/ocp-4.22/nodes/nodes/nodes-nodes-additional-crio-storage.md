...
- [Running background tasks on nodes automatically with daemon sets](../jobs/nodes-pods-daemonsets.md#nodes-pods-daemonsets)

- [Using machine config objects to configure nodes](../../machine_configuration/machine-configs-configure.md#machine-configs-configure)

- [Image mode for OpenShift](../../machine_configuration/mco-coreos-layering.md#mco-coreos-layering)
