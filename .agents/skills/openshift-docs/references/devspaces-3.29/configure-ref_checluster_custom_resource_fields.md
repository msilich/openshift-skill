> Source: [Red Hat OpenShift Dev Spaces 3.29](https://docs.redhat.com/en/documentation/red_hat_openshift_dev_spaces/3.29/configure-ref_checluster_custom_resource_fields). Copyright Red Hat.
...
<span id="ref_checluster-custom-resource-fields_devspaces__entry__1"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__2"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__3"></span>
...
| deploymentStrategy | DeploymentStrategy defines the deployment strategy to use to replace existing workspace pods with new ones. The available deployment strategies are `Recreate` and `RollingUpdate`. With the `Recreate` deployment strategy, the existing workspace pod is killed before the new one is created. With the `RollingUpdate` deployment strategy, a new workspace pod is created and the existing workspace pod is deleted only when the new workspace pod is in a ready state. If not specified, the default `Recreate` deployment strategy is used. |  |
...
<span id="ref_checluster-custom-resource-fields_devspaces__entry__112"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__113"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__114"></span>
...
Table 2. `allowedSources` options.

<span id="ref_checluster-custom-resource-fields_devspaces__entry__118"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__119"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__120"></span>
...
| template | If you do not create the user namespaces in advance, this field defines the Kubernetes namespace created when you start your first workspace. You can use `<username>` and `<userid>` placeholders, such as che-workspace-\<username\>. | "\<username\>-che" |

Table 3. `defaultNamespace` options.

<span id="ref_checluster-custom-resource-fields_devspaces__entry__127"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__128"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__129"></span>
...
Table 4. `defaultPlugins` options.

<span id="ref_checluster-custom-resource-fields_devspaces__entry__136"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__137"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__138"></span>

| Property | Description                                              | Default |
|----------|----------------------------------------------------------|---------|
| editor   | The editor ID must have `publisher/name/version` format. |         |
| url      | The download URL for the editor.                         |         |

Table 5. `editorsDownloadUrls` options.

<span id="ref_checluster-custom-resource-fields_devspaces__entry__145"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__146"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__147"></span>
...
Table 6. `gatewayContainer` options.

<span id="ref_checluster-custom-resource-fields_devspaces__entry__163"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__164"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__165"></span>

| Property          | Description                 | Default |
|-------------------|-----------------------------|---------|
| externalTLSConfig | External TLS configuration. |         |

Table 7. `networking` options.

<span id="ref_checluster-custom-resource-fields_devspaces__entry__169"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__170"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__171"></span>
...
Table 8. `externalTLSConfig` options.

<span id="ref_checluster-custom-resource-fields_devspaces__entry__181"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__182"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__183"></span>
...
Table 9. `persistUserHome` options.

<span id="ref_checluster-custom-resource-fields_devspaces__entry__190"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__191"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__192"></span>
...
Table 10. `projectCloneContainer` options.

<span id="ref_checluster-custom-resource-fields_devspaces__entry__208"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__209"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__210"></span>
...
<span id="ref_checluster-custom-resource-fields_devspaces__entry__217"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__218"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__219"></span>
...
Table 12. `storage` options.

<span id="ref_checluster-custom-resource-fields_devspaces__entry__229"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__230"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__231"></span>
...
Table 13. `per-user` PVC strategy options.

<span id="ref_checluster-custom-resource-fields_devspaces__entry__241"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__242"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__243"></span>
...
Table 14. `per-workspace` PVC strategy options.

<span id="ref_checluster-custom-resource-fields_devspaces__entry__253"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__254"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__255"></span>
...
Table 15. `trustedCerts` options.

<span id="ref_checluster-custom-resource-fields_devspaces__entry__262"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__263"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__264"></span>
...
Table 16. `user` options.

<span id="ref_checluster-custom-resource-fields_devspaces__entry__268"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__269"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__270"></span>

| Property | Description | Default |
|----|----|----|
| openShiftSecurityContextConstraint | OpenShift security context constraint to build containers. | "container-build" |

Table 17. `containerBuildConfiguration` options.

<span id="ref_checluster-custom-resource-fields_devspaces__entry__274"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__275"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__276"></span>

| Property | Description | Default |
|----|----|----|
| containerSecurityContext | SecurityContext applied to all workspace containers when run capabilities are enabled. The default `procMount: "Unmasked"` is set because the pod runs in a user namespace, which safely isolates the container’s `/proc` from the host. This allows the container to modify its own sysctl settings for configuring networking for nested containers. | { "allowPrivilegeEscalation": true, "capabilities": { "add": \[ "SETGID", "SETUID" \] }, "procMount": "Unmasked"} |
...
Table 18. `containerRunConfiguration` options.

<span id="ref_checluster-custom-resource-fields_devspaces__entry__286"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__287"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__288"></span>
...
Table 19. OpenShift Dev Spaces components configuration.

<span id="ref_checluster-custom-resource-fields_devspaces__entry__310"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__311"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__312"></span>
...
Table 20. General configuration settings related to the OpenShift Dev Spaces server component.

<span id="ref_checluster-custom-resource-fields_devspaces__entry__331"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__332"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__333"></span>
...
Table 21. `proxy` options.

<span id="ref_checluster-custom-resource-fields_devspaces__entry__346"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__347"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__348"></span>
...
Table 22. Configuration settings related to the Plug-in registry component used by the OpenShift Dev Spaces installation.

<span id="ref_checluster-custom-resource-fields_devspaces__entry__361"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__362"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__363"></span>

| Property | Description                         | Default |
|----------|-------------------------------------|---------|
| url      | Public URL of the plug-in registry. |         |

Table 23. `externalPluginRegistries` options.

<span id="ref_checluster-custom-resource-fields_devspaces__entry__367"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__368"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__369"></span>
...
Table 24. Configuration settings related to the Devfile registry component used by the OpenShift Dev Spaces installation.

<span id="ref_checluster-custom-resource-fields_devspaces__entry__379"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__380"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__381"></span>

| Property | Description | Default |
|----|----|----|
| url | The public URL of the devfile registry that serves sample ready-to-use devfiles. |  |

Table 25. `externalDevfileRegistries` options.

<span id="ref_checluster-custom-resource-fields_devspaces__entry__385"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__386"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__387"></span>
...
Table 26. Configuration settings related to the Dashboard component used by the OpenShift Dev Spaces installation.

<span id="ref_checluster-custom-resource-fields_devspaces__entry__400"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__401"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__402"></span>
...
Table 27. `headerMessage` options.

<span id="ref_checluster-custom-resource-fields_devspaces__entry__409"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__410"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__411"></span>

| Property | Description     | Default |
|----------|-----------------|---------|
| logo     | Dashboard logo. |         |

Table 28. `branding` options.

<span id="ref_checluster-custom-resource-fields_devspaces__entry__415"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__416"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__417"></span>
...
Table 29. Kubernetes Image Puller component configuration.

<span id="ref_checluster-custom-resource-fields_devspaces__entry__424"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__425"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__426"></span>

| Property | Description | Default |
|----|----|----|
| enable | Enables `metrics` for the OpenShift Dev Spaces server endpoint. | true |

Table 30. OpenShift Dev Spaces server metrics component configuration.

<span id="ref_checluster-custom-resource-fields_devspaces__entry__430"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__431"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__432"></span>
...
Table 31. Configuration settings that allows users to work with remote Git repositories.

<span id="ref_checluster-custom-resource-fields_devspaces__entry__445"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__446"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__447"></span>
...
Table 32. `github` options.

<span id="ref_checluster-custom-resource-fields_devspaces__entry__457"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__458"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__459"></span>
...
Table 33. `gitlab` options.

<span id="ref_checluster-custom-resource-fields_devspaces__entry__466"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__467"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__468"></span>
...
Table 34. `bitbucket` options.

<span id="ref_checluster-custom-resource-fields_devspaces__entry__475"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__476"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__477"></span>
...
Table 35. `azure` options.

<span id="ref_checluster-custom-resource-fields_devspaces__entry__481"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__482"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__483"></span>
...
Table 36. Networking, OpenShift Dev Spaces authentication and TLS configuration.

<span id="ref_checluster-custom-resource-fields_devspaces__entry__505"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__506"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__507"></span>
...
Table 37. `auth` options.

<span id="ref_checluster-custom-resource-fields_devspaces__entry__535"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__536"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__537"></span>
...
Table 38. `gateway` options.

<span id="ref_checluster-custom-resource-fields_devspaces__entry__553"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__554"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__555"></span>
...
Table 39. `advancedAuthorization` options.

<span id="ref_checluster-custom-resource-fields_devspaces__entry__568"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__569"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__570"></span>
...
Table 40. Configuration of an alternative registry that stores OpenShift Dev Spaces images.

<span id="ref_checluster-custom-resource-fields_devspaces__entry__577"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__578"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__579"></span>
...
Table 41. `deployment` options.

<span id="ref_checluster-custom-resource-fields_devspaces__entry__592"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__593"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__594"></span>
...
Table 42. `containers` options.

<span id="ref_checluster-custom-resource-fields_devspaces__entry__610"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__611"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__612"></span>
...
Table 43. `resources` options.

<span id="ref_checluster-custom-resource-fields_devspaces__entry__619"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__620"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__621"></span>
...
Table 44. `request` options.

<span id="ref_checluster-custom-resource-fields_devspaces__entry__628"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__629"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__630"></span>
...
Table 45. `limits` options.

<span id="ref_checluster-custom-resource-fields_devspaces__entry__637"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__638"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__639"></span>
...
Table 46. `securityContext` options.

<span id="ref_checluster-custom-resource-fields_devspaces__entry__646"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__647"></span><span id="ref_checluster-custom-resource-fields_devspaces__entry__648"></span>
...
Table 47. `CheCluster` Custom Resource `status` defines the observed state of OpenShift Dev Spaces installation
