...
- [Mirroring an image set in a partially disconnected environment](about-installing-oc-mirror-v2.md#oc-mirror-workflows-partially-disconnected-v2_about-installing-oc-mirror-v2)
