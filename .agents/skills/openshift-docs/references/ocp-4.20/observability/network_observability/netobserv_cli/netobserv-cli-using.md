...
4.  To stop capturing, press <span class="keycombo">Ctrl+C</span>. The data that was captured is written to two separate files in an `./output` directory located in the same path used to install the CLI.
...
4.  To stop capturing, press <span class="keycombo">Ctrl+C</span>.
...
- [Network Observability CLI reference](netobserv-cli-reference.md#network-observability-netobserv-cli-reference_netobserv-cli-reference)
