...
You can migrate your applications by using the Migration Toolkit for Containers (MTC) web console or from the [command line](advanced-migration-options-3-4.md#migrating-applications-cli_advanced-migration-options-3-4).
...
- [Manually exposing a secure registry for OpenShift Container Platform 3](https://docs.openshift.com/container-platform/3.11/install_config/registry/securing_and_exposing_registry.html#exposing-the-registry)

- [Updating deprecated internal images](troubleshooting-3-4.md#migration-updating-deprecated-internal-images_troubleshooting-3-4)
...
3.  Select a **Storage provider type** and fill in the following fields:
    ...
    - **Google Cloud**:
      ...
      - **Google Cloud bucket name**: Specify the name of the Google Cloud bucket.

      - **Google Cloud credential JSON blob**: Specify the string in the `credentials-velero` file.
...
- [MTC file system copy method](about-mtc-3-4.md#file-system-copy-method_about-mtc-3-4)

- [MTC snapshot copy method](about-mtc-3-4.md#snapshot-copy-method_about-mtc-3-4)
...
2.  Click the Options menu ![kebab](data:image/png;base64,) next to a migration plan and select one of the following options under **Migration**:
