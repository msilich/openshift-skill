...
- For information about creating a MigCluster CR manifest for each remote cluster, see [Migrating an application by using the MTC API](advanced-migration-options-3-4.md#migration-migrating-applications-api_advanced-migration-options-3-4).

- For information about adding a cluster using the web console, see [Migrating your applications by using the MTC web console](migrating-applications-3-4.md#migrating-applications-mtc-web-console_migrating-applications-3-4)
...
- The OpenShift image registry must be exposed to external traffic on all remote clusters.
  ...
  The OpenShift Container Platform 3 registry must be [exposed manually](https://docs.openshift.com/container-platform/3.11/install_config/registry/securing_and_exposing_registry.html#exposing-the-registry).
...
- See [Excluding PVCs from migration](advanced-migration-options-3-4.md#migration-excluding-pvcs_advanced-migration-options-3-4) to select PVCs for state migration.

- See [Mapping PVCs](advanced-migration-options-3-4.md#migration-mapping-pvcs_advanced-migration-options-3-4) to migrate source PV data to provisioned PVCs on the destination cluster.

- See [Migrating Kubernetes objects](advanced-migration-options-3-4.md#migration-kubernetes-objects_advanced-migration-options-3-4) to migrate the Kubernetes objects that constitute an application’s state.
...
- For details about the `move` and `copy` actions, see [MTC workflow](about-mtc-3-4.md#migration-mtc-workflow_about-mtc-3-4).

- For details about the `skip` action, see [Excluding PVCs from migration](advanced-migration-options-3-4.md#migration-excluding-pvcs_advanced-migration-options-3-4).

- For details about the file system and snapshot copy methods, see [About data copy methods](about-mtc-3-4.md#migration-understanding-data-copy-methods_about-mtc-3-4).
