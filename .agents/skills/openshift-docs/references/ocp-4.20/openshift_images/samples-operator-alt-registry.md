...
- [Using Cluster Samples Operator image streams with alternate or mirrored registries](samples-operator-alt-registry.md#installation-restricted-network-samples_samples-operator-alt-registry)
