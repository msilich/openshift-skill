...
- [Example: Network interface with a VRF instance node network configuration policy](../k8s_nmstate/k8s-nmstate-updating-node-network-config.md#virt-example-host-vrf_k8s-nmstate-updating-node-network-config)

- [Managing symmetric routing with MetalLB](../ingress_load_balancing/metallb/metallb-configure-return-traffic.md#metallb-configure-return-traffic)
