...
You can configure a Single Root I/O Virtualization (SR-IOV) device in your cluster by using the [SR-IOV Operator](../networking_operators/sr-iov-operator/installing-sriov-operator.md#installing-sriov-operator).
...
- [Configuring multi-network policy](../multiple_networks/secondary_networks/configuring-multi-network-policy.md#configuring-multi-network-policy)

# Next steps

- [Configuring the SR-IOV Network Operator](../networking_operators/sr-iov-operator/configuring-sriov-operator.md#configuring-sriov-operator)

- [Configuring an SR-IOV network device](configuring-sriov-device.md#configuring-sriov-device)

- If you use OpenShift Virtualization: [Connecting a virtual machine to an SR-IOV network](../../virt/vm_networking/virt-connecting-vm-to-sriov.md#virt-connecting-vm-to-sriov)

- [Configuring an SR-IOV network attachment](configuring-sriov-net-attach.md#configuring-sriov-net-attach)

- [Ethernet network attachement: Adding a pod to an SR-IOV additional network](configuring-sriov-net-attach.md#configuring-sriov-net-attach)

- [InfiniBand network attachement: Adding a pod to an SR-IOV additional network](configuring-sriov-ib-attach.md#configuring-sriov-ib-attach)
