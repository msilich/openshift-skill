...
RHCOS is supported only as a component of OpenShift Container Platform 4.20 for all OpenShift Container Platform machines. RHCOS is the only supported operating system for all node types in OpenShift Container Platform. RHCOS is deployed in OpenShift Container Platform 4.20 in two general ways:
