...
- [Velero CPU and memory requirements based on collected data](../installing/about-installing-oadp.md#oadp-velero-cpu-memory-requirements_about-installing-oadp)
