...
The Data Mover uses [Kopia](../backing_up_and_restoring/oadp-about-kopia.md#oadp-about-kopia) as the uploader mechanism to read the snapshot data and write to the unified repository.
