...
- [Amazon Web Services](installing-oadp-aws.md#installing-oadp-aws)

- [Microsoft Azure](installing-oadp-azure.md#installing-oadp-azure)

- [Google Cloud](installing-oadp-gcp.md#installing-oadp-gcp)

- [Multicloud Object Gateway](installing-oadp-mcg.md#installing-oadp-mcg)
...
- CSI snapshot-enabled cloud provider, such as [OpenShift Data Foundation](installing-oadp-ocs.md#installing-oadp-ocs)
...
If your cloud provider does not support snapshots or if your storage is NFS, you can back up applications with [Backing up applications with File System Backup: Kopia or Restic](../backing_up_and_restoring/oadp-backing-up-applications-restic-doc.md#backing-up-applications) on object storage.
...
- [Cluster service version](../../../operators/understanding/olm/olm-understanding-olm.md#olm-csv_olm-understanding-olm)
