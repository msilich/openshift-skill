...
- [Understanding how to create secrets](nodes-pods-secrets.md#nodes-pods-secrets-creating_nodes-pods-secrets)

- [Configuring bound service account tokens using volume projection](../../authentication/bound-service-account-tokens.md#bound-sa-tokens-configuring_bound-service-account-tokens)
