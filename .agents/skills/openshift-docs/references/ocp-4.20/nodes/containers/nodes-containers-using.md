...
- [Creating a `ContainerRuntimeConfig` CR to edit CRI-O parameters](../../machine_configuration/machine-configs-custom.md#create-a-containerruntimeconfig_machine-configs-custom)
