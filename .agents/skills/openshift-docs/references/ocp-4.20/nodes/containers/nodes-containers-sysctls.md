...
- [Configuring system controls by using the tuning CNI](../../networking/configuring_network_settings/configure-syscontrols-interface-tuning-cni.md#nw-configuring-tuning-cni_configure-syscontrols-interface-tuning-cni)
