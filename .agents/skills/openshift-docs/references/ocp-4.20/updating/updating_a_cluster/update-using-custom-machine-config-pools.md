...
- [Updating a cluster using the web console](updating-cluster-web-console.md#update-upgrading-web_updating-cluster-web-console)

- [Updating a cluster using the CLI](updating-cluster-cli.md#update-upgrading-cli_updating-cluster-cli)
