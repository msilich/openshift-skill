...
| `data` | [`RawExtension`](../objects/index.md#io-k8s-apimachinery-pkg-runtime-RawExtension) | Data is the serialized representation of the state. |
...
|----|----|
| 200 - OK | [`ControllerRevisionList`](../objects/index.md#io-k8s-api-apps-v1-ControllerRevisionList) schema |
...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`ControllerRevision`](controllerrevision-apps-v1.md#controllerrevision-apps-v1) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`ControllerRevision`](controllerrevision-apps-v1.md#controllerrevision-apps-v1) schema |
| 201 - Created | [`ControllerRevision`](controllerrevision-apps-v1.md#controllerrevision-apps-v1) schema |
| 202 - Accepted | [`ControllerRevision`](controllerrevision-apps-v1.md#controllerrevision-apps-v1) schema |
| 401 - Unauthorized | Empty |
