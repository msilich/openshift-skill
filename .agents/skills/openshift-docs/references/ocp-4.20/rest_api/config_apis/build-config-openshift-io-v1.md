...
<p>The namespace for the ConfigMap referenced by trustedCA is "openshift-config". Here is an example ConfigMap (in yaml):</p>
<p>apiVersion: v1 kind: ConfigMap metadata: name: user-ca-bundle namespace: openshift-config data: ca-bundle.crt: | -----BEGIN CERTIFICATE----- Custom CA certificate bundle. -----END CERTIFICATE-----</p></td>
</tr>
</tbody>
</table>
...
| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`BuildList`](../objects/index.md#io-openshift-config-v1-BuildList) schema |
| 401 - Unauthorized | Empty |
...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`Build`](build-config-openshift-io-v1.md#build-config-openshift-io-v1) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`Build`](build-config-openshift-io-v1.md#build-config-openshift-io-v1) schema |
| 201 - Created | [`Build`](build-config-openshift-io-v1.md#build-config-openshift-io-v1) schema |
| 202 - Accepted | [`Build`](build-config-openshift-io-v1.md#build-config-openshift-io-v1) schema |
| 401 - Unauthorized | Empty |
