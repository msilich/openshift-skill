...
| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`ProxyList`](../objects/index.md#io-openshift-config-v1-ProxyList) schema |
| 401 - Unauthorized | Empty |
...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`Proxy`](proxy-config-openshift-io-v1.md#proxy-config-openshift-io-v1) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`Proxy`](proxy-config-openshift-io-v1.md#proxy-config-openshift-io-v1) schema |
| 201 - Created | [`Proxy`](proxy-config-openshift-io-v1.md#proxy-config-openshift-io-v1) schema |
| 202 - Accepted | [`Proxy`](proxy-config-openshift-io-v1.md#proxy-config-openshift-io-v1) schema |
| 401 - Unauthorized | Empty |
