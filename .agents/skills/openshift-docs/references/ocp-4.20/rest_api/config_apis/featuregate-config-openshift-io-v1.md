...
| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`FeatureGateList`](../objects/index.md#io-openshift-config-v1-FeatureGateList) schema |
| 401 - Unauthorized | Empty |
...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`FeatureGate`](featuregate-config-openshift-io-v1.md#featuregate-config-openshift-io-v1) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`FeatureGate`](featuregate-config-openshift-io-v1.md#featuregate-config-openshift-io-v1) schema |
| 201 - Created | [`FeatureGate`](featuregate-config-openshift-io-v1.md#featuregate-config-openshift-io-v1) schema |
| 202 - Accepted | [`FeatureGate`](featuregate-config-openshift-io-v1.md#featuregate-config-openshift-io-v1) schema |
| 401 - Unauthorized | Empty |
