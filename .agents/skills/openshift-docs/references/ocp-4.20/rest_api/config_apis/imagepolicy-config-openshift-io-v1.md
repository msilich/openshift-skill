...
|----|----|
| 200 - OK | [`ImagePolicyList`](../objects/index.md#io-openshift-config-v1-ImagePolicyList) schema |
...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`ImagePolicy`](imagepolicy-config-openshift-io-v1.md#imagepolicy-config-openshift-io-v1) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`ImagePolicy`](imagepolicy-config-openshift-io-v1.md#imagepolicy-config-openshift-io-v1) schema |
| 201 - Created | [`ImagePolicy`](imagepolicy-config-openshift-io-v1.md#imagepolicy-config-openshift-io-v1) schema |
| 202 - Accepted | [`ImagePolicy`](imagepolicy-config-openshift-io-v1.md#imagepolicy-config-openshift-io-v1) schema |
| 401 - Unauthorized | Empty |
