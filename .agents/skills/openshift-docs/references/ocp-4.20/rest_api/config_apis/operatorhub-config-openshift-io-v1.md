...
| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`OperatorHubList`](../objects/index.md#io-openshift-config-v1-OperatorHubList) schema |
| 401 - Unauthorized | Empty |
...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`OperatorHub`](operatorhub-config-openshift-io-v1.md#operatorhub-config-openshift-io-v1) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`OperatorHub`](operatorhub-config-openshift-io-v1.md#operatorhub-config-openshift-io-v1) schema |
| 201 - Created | [`OperatorHub`](operatorhub-config-openshift-io-v1.md#operatorhub-config-openshift-io-v1) schema |
| 202 - Accepted | [`OperatorHub`](operatorhub-config-openshift-io-v1.md#operatorhub-config-openshift-io-v1) schema |
| 401 - Unauthorized | Empty |
