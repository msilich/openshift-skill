...
| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`ClusterOperatorList`](../objects/index.md#io-openshift-config-v1-ClusterOperatorList) schema |
| 401 - Unauthorized | Empty |
...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`ClusterOperator`](clusteroperator-config-openshift-io-v1.md#clusteroperator-config-openshift-io-v1) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`ClusterOperator`](clusteroperator-config-openshift-io-v1.md#clusteroperator-config-openshift-io-v1) schema |
| 201 - Created | [`ClusterOperator`](clusteroperator-config-openshift-io-v1.md#clusteroperator-config-openshift-io-v1) schema |
| 202 - Accepted | [`ClusterOperator`](clusteroperator-config-openshift-io-v1.md#clusteroperator-config-openshift-io-v1) schema |
| 401 - Unauthorized | Empty |
