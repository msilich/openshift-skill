...
| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`HelmChartRepositoryList`](../objects/index.md#io-openshift-helm-v1beta1-HelmChartRepositoryList) schema |
| 401 - Unauthorized | Empty |
...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`HelmChartRepository`](helmchartrepository-helm-openshift-io-v1beta1.md#helmchartrepository-helm-openshift-io-v1beta1) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`HelmChartRepository`](helmchartrepository-helm-openshift-io-v1beta1.md#helmchartrepository-helm-openshift-io-v1beta1) schema |
| 201 - Created | [`HelmChartRepository`](helmchartrepository-helm-openshift-io-v1beta1.md#helmchartrepository-helm-openshift-io-v1beta1) schema |
| 202 - Accepted | [`HelmChartRepository`](helmchartrepository-helm-openshift-io-v1beta1.md#helmchartrepository-helm-openshift-io-v1beta1) schema |
| 401 - Unauthorized | Empty |
