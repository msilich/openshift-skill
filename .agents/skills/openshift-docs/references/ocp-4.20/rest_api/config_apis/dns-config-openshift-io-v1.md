...
<p>If this field is nil, no public records should be created.</p>
<p>Once set, this field cannot be changed.</p></td>
</tr>
</tbody>
</table>
...
<p>Individual components may not support all platforms, and must handle unrecognized platforms with best-effort defaults.</p></td>
</tr>
</tbody>
</table>
...
| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`DNSList`](../objects/index.md#io-openshift-config-v1-DNSList) schema |
| 401 - Unauthorized | Empty |
