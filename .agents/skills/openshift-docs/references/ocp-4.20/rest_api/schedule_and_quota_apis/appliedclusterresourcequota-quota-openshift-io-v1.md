...
| Property | Type | Description |
|----|----|----|
| `quota` | [`ResourceQuotaSpec_v2`](../objects/index.md#io-k8s-api-core-v1-ResourceQuotaSpec_v2) | Quota defines the desired quota |
...
| `labels` | [`LabelSelector_v4`](../objects/index.md#io-k8s-apimachinery-pkg-apis-meta-v1-LabelSelector_v4) | LabelSelector is used to select projects by label. |
