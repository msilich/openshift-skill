...
| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`ClusterResourceQuotaList`](../objects/index.md#io-openshift-quota-v1-ClusterResourceQuotaList) schema |
| 401 - Unauthorized | Empty |
...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`ClusterResourceQuota`](clusterresourcequota-quota-openshift-io-v1.md#clusterresourcequota-quota-openshift-io-v1) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`ClusterResourceQuota`](clusterresourcequota-quota-openshift-io-v1.md#clusterresourcequota-quota-openshift-io-v1) schema |
| 201 - Created | [`ClusterResourceQuota`](clusterresourcequota-quota-openshift-io-v1.md#clusterresourcequota-quota-openshift-io-v1) schema |
| 202 - Accepted | [`ClusterResourceQuota`](clusterresourcequota-quota-openshift-io-v1.md#clusterresourcequota-quota-openshift-io-v1) schema |
| 401 - Unauthorized | Empty |
