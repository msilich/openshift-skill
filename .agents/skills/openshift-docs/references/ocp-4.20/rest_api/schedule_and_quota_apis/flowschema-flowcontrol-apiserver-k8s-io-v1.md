...
| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`FlowSchemaList`](../objects/index.md#io-k8s-api-flowcontrol-v1-FlowSchemaList) schema |
| 401 - Unauthorized | Empty |
...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`FlowSchema`](flowschema-flowcontrol-apiserver-k8s-io-v1.md#flowschema-flowcontrol-apiserver-k8s-io-v1) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`FlowSchema`](flowschema-flowcontrol-apiserver-k8s-io-v1.md#flowschema-flowcontrol-apiserver-k8s-io-v1) schema |
| 201 - Created | [`FlowSchema`](flowschema-flowcontrol-apiserver-k8s-io-v1.md#flowschema-flowcontrol-apiserver-k8s-io-v1) schema |
| 202 - Accepted | [`FlowSchema`](flowschema-flowcontrol-apiserver-k8s-io-v1.md#flowschema-flowcontrol-apiserver-k8s-io-v1) schema |
| 401 - Unauthorized | Empty |
