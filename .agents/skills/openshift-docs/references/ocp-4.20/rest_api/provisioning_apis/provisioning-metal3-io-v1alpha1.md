...
| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`ProvisioningList`](../objects/index.md#io-metal3-v1alpha1-ProvisioningList) schema |
| 401 - Unauthorized | Empty |
...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`Provisioning`](provisioning-metal3-io-v1alpha1.md#provisioning-metal3-io-v1alpha1) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`Provisioning`](provisioning-metal3-io-v1alpha1.md#provisioning-metal3-io-v1alpha1) schema |
| 201 - Created | [`Provisioning`](provisioning-metal3-io-v1alpha1.md#provisioning-metal3-io-v1alpha1) schema |
| 202 - Accepted | [`Provisioning`](provisioning-metal3-io-v1alpha1.md#provisioning-metal3-io-v1alpha1) schema |
| 401 - Unauthorized | Empty |
