...
| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`ConfigList`](../objects/index.md#io-openshift-operator-imageregistry-v1-ConfigList) schema |
| 401 - Unauthorized | Empty |
...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`Config`](config-imageregistry-operator-openshift-io-v1.md#config-imageregistry-operator-openshift-io-v1) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`Config`](config-imageregistry-operator-openshift-io-v1.md#config-imageregistry-operator-openshift-io-v1) schema |
| 201 - Created | [`Config`](config-imageregistry-operator-openshift-io-v1.md#config-imageregistry-operator-openshift-io-v1) schema |
| 202 - Accepted | [`Config`](config-imageregistry-operator-openshift-io-v1.md#config-imageregistry-operator-openshift-io-v1) schema |
| 401 - Unauthorized | Empty |
