...
| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`CloudCredentialList`](../objects/index.md#io-openshift-operator-v1-CloudCredentialList) schema |
| 401 - Unauthorized | Empty |
...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`CloudCredential`](cloudcredential-operator-openshift-io-v1.md#cloudcredential-operator-openshift-io-v1) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`CloudCredential`](cloudcredential-operator-openshift-io-v1.md#cloudcredential-operator-openshift-io-v1) schema |
| 201 - Created | [`CloudCredential`](cloudcredential-operator-openshift-io-v1.md#cloudcredential-operator-openshift-io-v1) schema |
| 202 - Accepted | [`CloudCredential`](cloudcredential-operator-openshift-io-v1.md#cloudcredential-operator-openshift-io-v1) schema |
| 401 - Unauthorized | Empty |
