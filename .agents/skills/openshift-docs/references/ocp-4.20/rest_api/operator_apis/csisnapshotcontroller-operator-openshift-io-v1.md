...
| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`CSISnapshotControllerList`](../objects/index.md#io-openshift-operator-v1-CSISnapshotControllerList) schema |
| 401 - Unauthorized | Empty |
...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`CSISnapshotController`](csisnapshotcontroller-operator-openshift-io-v1.md#csisnapshotcontroller-operator-openshift-io-v1) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`CSISnapshotController`](csisnapshotcontroller-operator-openshift-io-v1.md#csisnapshotcontroller-operator-openshift-io-v1) schema |
| 201 - Created | [`CSISnapshotController`](csisnapshotcontroller-operator-openshift-io-v1.md#csisnapshotcontroller-operator-openshift-io-v1) schema |
| 202 - Accepted | [`CSISnapshotController`](csisnapshotcontroller-operator-openshift-io-v1.md#csisnapshotcontroller-operator-openshift-io-v1) schema |
| 401 - Unauthorized | Empty |
