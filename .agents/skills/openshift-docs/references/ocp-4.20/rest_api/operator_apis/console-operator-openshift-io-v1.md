...
<tbody>
<tr>
<td style="text-align: left;"><p><code>customization</code></p></td>
<td style="text-align: left;"><p><code>object</code></p></td>
<td style="text-align: left;"><p>customization is used to optionally provide a small set of customization options to the web console.</p></td>
</tr>
<tr>
<td style="text-align: left;"><p><code>ingress</code></p></td>
<td style="text-align: left;"><p><code>object</code></p></td>
<td style="text-align: left;"><p>ingress allows to configure the alternative ingress for the console. This field is intended for clusters without ingress capability, where access to routes is not possible.</p></td>
</tr>
<tr>
...
<td style="text-align: left;"><p>plugins defines a list of enabled console plugin names.</p></td>
</tr>
<tr>
<td style="text-align: left;"><p><code>providers</code></p></td>
<td style="text-align: left;"><p><code>object</code></p></td>
<td style="text-align: left;"><p>providers contains configuration for using specific service providers.</p></td>
</tr>
<tr>
<td style="text-align: left;"><p><code>route</code></p></td>
<td style="text-align: left;"><p><code>object</code></p></td>
<td style="text-align: left;"><p>route contains hostname and secret reference that contains the serving certificate. If a custom route is specified, a new route will be created with the provided hostname, under which console will be available. In case of custom hostname uses the default routing suffix of the cluster, the Secret specification for a serving certificate will not be needed. In case of custom hostname points to an arbitrary domain, manual DNS configurations steps are necessary. The default console route will be maintained to reserve the default hostname for console if the custom route is removed. If not specified, default route will be used. DEPRECATED</p></td>
</tr>
<tr>
...
| Property | Type | Description |
|----|----|----|
| `name` | `string` | name is the unique name of a capability. Available capabilities are LightspeedButton and GettingStartedBanner. |
...
Description
configMap specifies the ConfigMap sourcing details such as the name of the ConfigMap and the key for the file. The ConfigMap must exist in the openshift-config namespace. Required when from is "ConfigMap", and forbidden otherwise.
...
| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`ConsoleList`](../objects/index.md#io-openshift-operator-v1-ConsoleList) schema |
| 401 - Unauthorized | Empty |
...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`Console`](console-operator-openshift-io-v1.md#console-operator-openshift-io-v1) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`Console`](console-operator-openshift-io-v1.md#console-operator-openshift-io-v1) schema |
| 201 - Created | [`Console`](console-operator-openshift-io-v1.md#console-operator-openshift-io-v1) schema |
| 202 - Accepted | [`Console`](console-operator-openshift-io-v1.md#console-operator-openshift-io-v1) schema |
| 401 - Unauthorized | Empty |
