...
| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`ServiceCAList`](../objects/index.md#io-openshift-operator-v1-ServiceCAList) schema |
| 401 - Unauthorized | Empty |
...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`ServiceCA`](serviceca-operator-openshift-io-v1.md#serviceca-operator-openshift-io-v1) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`ServiceCA`](serviceca-operator-openshift-io-v1.md#serviceca-operator-openshift-io-v1) schema |
| 201 - Created | [`ServiceCA`](serviceca-operator-openshift-io-v1.md#serviceca-operator-openshift-io-v1) schema |
| 202 - Accepted | [`ServiceCA`](serviceca-operator-openshift-io-v1.md#serviceca-operator-openshift-io-v1) schema |
| 401 - Unauthorized | Empty |
