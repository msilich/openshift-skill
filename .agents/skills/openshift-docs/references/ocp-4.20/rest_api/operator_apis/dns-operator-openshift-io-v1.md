...
| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`DNSList`](../objects/index.md#io-openshift-operator-v1-DNSList) schema |
| 401 - Unauthorized | Empty |
...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`DNS`](dns-operator-openshift-io-v1.md#dns-operator-openshift-io-v1) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`DNS`](dns-operator-openshift-io-v1.md#dns-operator-openshift-io-v1) schema |
| 201 - Created | [`DNS`](dns-operator-openshift-io-v1.md#dns-operator-openshift-io-v1) schema |
| 202 - Accepted | [`DNS`](dns-operator-openshift-io-v1.md#dns-operator-openshift-io-v1) schema |
| 401 - Unauthorized | Empty |
