...
| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`ConfigList`](../objects/index.md#io-openshift-operator-v1-ConfigList) schema |
| 401 - Unauthorized | Empty |
...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`Config`](config-operator-openshift-io-v1.md#config-operator-openshift-io-v1) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`Config`](config-operator-openshift-io-v1.md#config-operator-openshift-io-v1) schema |
| 201 - Created | [`Config`](config-operator-openshift-io-v1.md#config-operator-openshift-io-v1) schema |
| 202 - Accepted | [`Config`](config-operator-openshift-io-v1.md#config-operator-openshift-io-v1) schema |
| 401 - Unauthorized | Empty |
