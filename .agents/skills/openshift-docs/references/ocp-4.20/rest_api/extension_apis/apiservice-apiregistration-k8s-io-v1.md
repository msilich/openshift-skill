...
| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`APIServiceList`](../objects/index.md#io-k8s-kube-aggregator-pkg-apis-apiregistration-v1-APIServiceList) schema |
| 401 - Unauthorized | Empty |
...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`APIService`](apiservice-apiregistration-k8s-io-v1.md#apiservice-apiregistration-k8s-io-v1) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`APIService`](apiservice-apiregistration-k8s-io-v1.md#apiservice-apiregistration-k8s-io-v1) schema |
| 201 - Created | [`APIService`](apiservice-apiregistration-k8s-io-v1.md#apiservice-apiregistration-k8s-io-v1) schema |
| 202 - Accepted | [`APIService`](apiservice-apiregistration-k8s-io-v1.md#apiservice-apiregistration-k8s-io-v1) schema |
| 401 - Unauthorized | Empty |
