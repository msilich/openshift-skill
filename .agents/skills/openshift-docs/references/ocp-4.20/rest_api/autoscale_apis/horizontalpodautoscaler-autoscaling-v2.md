...
| `metadata` | [`ObjectMeta`](../objects/index.md#io-k8s-apimachinery-pkg-apis-meta-v1-ObjectMeta) | metadata is the standard object metadata. More info: <https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata> |
...
| `averageValue` | [`Quantity`](../objects/index.md#io-k8s-apimachinery-pkg-api-resource-Quantity) | averageValue is the target value of the average of the metric across all relevant pods (as a quantity) |
| `type` | `string` | type represents whether the metric type is Utilization, Value, or AverageValue |
| `value` | [`Quantity`](../objects/index.md#io-k8s-apimachinery-pkg-api-resource-Quantity) | value is the target value of the metric (as a quantity). |
...
| `selector` | [`LabelSelector`](../objects/index.md#io-k8s-apimachinery-pkg-apis-meta-v1-LabelSelector) | selector is the string-encoded form of a standard kubernetes label selector for the given metric When set, it is passed as an additional parameter to the metrics server for more specific metrics scoping. When unset, just the metricName will be used to gather metrics. |
...
| `lastScaleTime` | [`Time`](../objects/index.md#io-k8s-apimachinery-pkg-apis-meta-v1-Time) | lastScaleTime is the last time the HorizontalPodAutoscaler scaled the number of pods, used by the autoscaler to control how often the number of pods is changed. |
...
| Property | Type | Description |
|----|----|----|
| `lastTransitionTime` | [`Time`](../objects/index.md#io-k8s-apimachinery-pkg-apis-meta-v1-Time) | lastTransitionTime is the last time the condition transitioned from one status to another |
...
| `averageValue` | [`Quantity`](../objects/index.md#io-k8s-apimachinery-pkg-api-resource-Quantity) | averageValue is the current value of the average of the metric across all relevant pods (as a quantity) |
| `value` | [`Quantity`](../objects/index.md#io-k8s-apimachinery-pkg-api-resource-Quantity) | value is the current value of the metric (as a quantity). |
...
|----|----|
| 200 - OK | [`HorizontalPodAutoscalerList`](../objects/index.md#io-k8s-api-autoscaling-v2-HorizontalPodAutoscalerList) schema |
...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`HorizontalPodAutoscaler`](horizontalpodautoscaler-autoscaling-v2.md#horizontalpodautoscaler-autoscaling-v2) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`HorizontalPodAutoscaler`](horizontalpodautoscaler-autoscaling-v2.md#horizontalpodautoscaler-autoscaling-v2) schema |
| 201 - Created | [`HorizontalPodAutoscaler`](horizontalpodautoscaler-autoscaling-v2.md#horizontalpodautoscaler-autoscaling-v2) schema |
| 202 - Accepted | [`HorizontalPodAutoscaler`](horizontalpodautoscaler-autoscaling-v2.md#horizontalpodautoscaler-autoscaling-v2) schema |
| 401 - Unauthorized | Empty |
