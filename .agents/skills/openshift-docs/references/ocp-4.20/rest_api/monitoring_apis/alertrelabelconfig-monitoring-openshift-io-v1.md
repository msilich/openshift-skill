...
|----|----|
| 200 - OK | [`AlertRelabelConfigList`](../objects/index.md#io-openshift-monitoring-v1-AlertRelabelConfigList) schema |
...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`AlertRelabelConfig`](alertrelabelconfig-monitoring-openshift-io-v1.md#alertrelabelconfig-monitoring-openshift-io-v1) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`AlertRelabelConfig`](alertrelabelconfig-monitoring-openshift-io-v1.md#alertrelabelconfig-monitoring-openshift-io-v1) schema |
| 201 - Created | [`AlertRelabelConfig`](alertrelabelconfig-monitoring-openshift-io-v1.md#alertrelabelconfig-monitoring-openshift-io-v1) schema |
| 202 - Accepted | [`AlertRelabelConfig`](alertrelabelconfig-monitoring-openshift-io-v1.md#alertrelabelconfig-monitoring-openshift-io-v1) schema |
| 401 - Unauthorized | Empty |
...
| Parameter | Type     | Description                    |
|-----------|----------|--------------------------------|
| `name`    | `string` | name of the AlertRelabelConfig |
