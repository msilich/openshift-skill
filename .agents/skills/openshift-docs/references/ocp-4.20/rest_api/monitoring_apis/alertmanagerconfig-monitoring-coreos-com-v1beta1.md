...
| `text`         | `string`  | Message body template.                   |
| `title`        | `string`  | Message title template.                  |
| `webhookURL`   | `object`  | MSTeams incoming webhook URL.            |
...
| Property | Type      | Description                                       |
|----------|-----------|---------------------------------------------------|
| `short`  | `boolean` | Whether the field is displayed in a compact form. |
...
| `timeIntervals`   | `array`  | TimeIntervals is a list of TimePeriod. |
...
| Property    | Type     | Description                                 |
|-------------|----------|---------------------------------------------|
| `endTime`   | `string` | EndTime is the end time in 24hr format.     |
| `startTime` | `string` | StartTime is the start time in 24hr format. |
