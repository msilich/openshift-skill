...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`PodSecurityPolicyReview`](podsecuritypolicyreview-security-openshift-io-v1.md#podsecuritypolicyreview-security-openshift-io-v1) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`PodSecurityPolicyReview`](podsecuritypolicyreview-security-openshift-io-v1.md#podsecuritypolicyreview-security-openshift-io-v1) schema |
| 201 - Created | [`PodSecurityPolicyReview`](podsecuritypolicyreview-security-openshift-io-v1.md#podsecuritypolicyreview-security-openshift-io-v1) schema |
| 202 - Accepted | [`PodSecurityPolicyReview`](podsecuritypolicyreview-security-openshift-io-v1.md#podsecuritypolicyreview-security-openshift-io-v1) schema |
