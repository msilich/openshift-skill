...
|----|----|
| 200 - OK | [`Status_v8`](../objects/index.md#io-k8s-apimachinery-pkg-apis-meta-v1-Status_v8) schema |
...
| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`RangeAllocationList`](../objects/index.md#com-github-openshift-api-security-v1-RangeAllocationList) schema |
| 401 - Unauthorized | Empty |
...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`RangeAllocation`](rangeallocation-security-openshift-io-v1.md#rangeallocation-security-openshift-io-v1) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`RangeAllocation`](rangeallocation-security-openshift-io-v1.md#rangeallocation-security-openshift-io-v1) schema |
| 201 - Created | [`RangeAllocation`](rangeallocation-security-openshift-io-v1.md#rangeallocation-security-openshift-io-v1) schema |
| 202 - Accepted | [`RangeAllocation`](rangeallocation-security-openshift-io-v1.md#rangeallocation-security-openshift-io-v1) schema |
| 401 - Unauthorized | Empty |
...
|----|----|
| 200 - OK | [`Status_v8`](../objects/index.md#io-k8s-apimachinery-pkg-apis-meta-v1-Status_v8) schema |
| 202 - Accepted | [`Status_v8`](../objects/index.md#io-k8s-apimachinery-pkg-apis-meta-v1-Status_v8) schema |
| 401 - Unauthorized | Empty |
