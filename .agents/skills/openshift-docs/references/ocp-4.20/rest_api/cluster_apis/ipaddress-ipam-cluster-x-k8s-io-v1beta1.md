...
|----|----|
| 200 - OK | [`IPAddressList`](../objects/index.md#io-x-k8s-cluster-ipam-v1beta1-IPAddressList) schema |
...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`IPAddress`](ipaddress-ipam-cluster-x-k8s-io-v1beta1.md#ipaddress-ipam-cluster-x-k8s-io-v1beta1) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`IPAddress`](ipaddress-ipam-cluster-x-k8s-io-v1beta1.md#ipaddress-ipam-cluster-x-k8s-io-v1beta1) schema |
| 201 - Created | [`IPAddress`](ipaddress-ipam-cluster-x-k8s-io-v1beta1.md#ipaddress-ipam-cluster-x-k8s-io-v1beta1) schema |
| 202 - Accepted | [`IPAddress`](ipaddress-ipam-cluster-x-k8s-io-v1beta1.md#ipaddress-ipam-cluster-x-k8s-io-v1beta1) schema |
| 401 - Unauthorized | Empty |
