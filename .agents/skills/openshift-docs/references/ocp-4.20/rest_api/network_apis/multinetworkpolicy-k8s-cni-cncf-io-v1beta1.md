...
|----|----|
| 200 - OK | [`MultiNetworkPolicyList`](../objects/index.md#io-cncf-cni-k8s-v1beta1-MultiNetworkPolicyList) schema |
...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`MultiNetworkPolicy`](multinetworkpolicy-k8s-cni-cncf-io-v1beta1.md#multinetworkpolicy-k8s-cni-cncf-io-v1beta1) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`MultiNetworkPolicy`](multinetworkpolicy-k8s-cni-cncf-io-v1beta1.md#multinetworkpolicy-k8s-cni-cncf-io-v1beta1) schema |
| 201 - Created | [`MultiNetworkPolicy`](multinetworkpolicy-k8s-cni-cncf-io-v1beta1.md#multinetworkpolicy-k8s-cni-cncf-io-v1beta1) schema |
| 202 - Accepted | [`MultiNetworkPolicy`](multinetworkpolicy-k8s-cni-cncf-io-v1beta1.md#multinetworkpolicy-k8s-cni-cncf-io-v1beta1) schema |
| 401 - Unauthorized | Empty |
...
| Parameter | Type     | Description                    |
|-----------|----------|--------------------------------|
| `name`    | `string` | name of the MultiNetworkPolicy |
