...
|----|----|
| 200 - OK | [`TemplateList`](../objects/index.md#com-github-openshift-api-template-v1-TemplateList) schema |
...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`Template`](template-template-openshift-io-v1.md#template-template-openshift-io-v1) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`Template`](template-template-openshift-io-v1.md#template-template-openshift-io-v1) schema |
| 201 - Created | [`Template`](template-template-openshift-io-v1.md#template-template-openshift-io-v1) schema |
| 202 - Accepted | [`Template`](template-template-openshift-io-v1.md#template-template-openshift-io-v1) schema |
| 401 - Unauthorized | Empty |
