...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`SubjectAccessReview`](subjectaccessreview-authorization-openshift-io-v1.md#subjectaccessreview-authorization-openshift-io-v1) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`SubjectAccessReview`](subjectaccessreview-authorization-openshift-io-v1.md#subjectaccessreview-authorization-openshift-io-v1) schema |
| 201 - Created | [`SubjectAccessReview`](subjectaccessreview-authorization-openshift-io-v1.md#subjectaccessreview-authorization-openshift-io-v1) schema |
| 202 - Accepted | [`SubjectAccessReview`](subjectaccessreview-authorization-openshift-io-v1.md#subjectaccessreview-authorization-openshift-io-v1) schema |
