...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`DeploymentRequest`](deploymentrequest-apps-openshift-io-v1.md#deploymentrequest-apps-openshift-io-v1) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`DeploymentRequest`](deploymentrequest-apps-openshift-io-v1.md#deploymentrequest-apps-openshift-io-v1) schema |
| 201 - Created | [`DeploymentRequest`](deploymentrequest-apps-openshift-io-v1.md#deploymentrequest-apps-openshift-io-v1) schema |
| 202 - Accepted | [`DeploymentRequest`](deploymentrequest-apps-openshift-io-v1.md#deploymentrequest-apps-openshift-io-v1) schema |
