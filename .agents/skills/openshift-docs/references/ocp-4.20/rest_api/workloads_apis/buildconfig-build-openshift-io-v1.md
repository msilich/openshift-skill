...
| `metadata` | [`ObjectMeta_v2`](../objects/index.md#io-k8s-apimachinery-pkg-apis-meta-v1-ObjectMeta_v2) | metadata is the standard object’s metadata. More info: <https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata> |
...
| Property | Type | Description |
|----|----|----|
| `configMap` | [`ConfigMapVolumeSource_v2`](../objects/index.md#io-k8s-api-core-v1-ConfigMapVolumeSource_v2) | configMap represents a ConfigMap that should populate this volume |
...
| `secret` | [`SecretVolumeSource_v2`](../objects/index.md#io-k8s-api-core-v1-SecretVolumeSource_v2) | secret represents a Secret that should populate this volume. More info: <https://kubernetes.io/docs/concepts/storage/volumes#secret> |
...
| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`Status_v4`](../objects/index.md#io-k8s-apimachinery-pkg-apis-meta-v1-Status_v4) schema |
| 401 - Unauthorized | Empty |
...
|----|----|
| 200 - OK | [`Status_v4`](../objects/index.md#io-k8s-apimachinery-pkg-apis-meta-v1-Status_v4) schema |
| 202 - Accepted | [`Status_v4`](../objects/index.md#io-k8s-apimachinery-pkg-apis-meta-v1-Status_v4) schema |
| 401 - Unauthorized | Empty |
