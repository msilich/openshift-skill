...
| `from` | [`ObjectReference`](../objects/index.md#io-k8s-api-core-v1-ObjectReference) | from is the reference to the ImageStreamTag that triggered the build. |
...
| `triggeredByImage` | [`ObjectReference`](../objects/index.md#io-k8s-api-core-v1-ObjectReference) | triggeredByImage is the Image that triggered this build. |
...
| Property | Type | Description |
|----|----|----|
| `buildArgs` | [`array (EnvVar)`](../objects/index.md#io-k8s-api-core-v1-EnvVar) | Args contains any build arguments that are to be passed to Docker. See <https://docs.docker.com/engine/reference/builder/#/arg> for more details |
...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`BuildRequest`](buildrequest-build-openshift-io-v1.md#buildrequest-build-openshift-io-v1) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`BuildRequest`](buildrequest-build-openshift-io-v1.md#buildrequest-build-openshift-io-v1) schema |
| 201 - Created | [`BuildRequest`](buildrequest-build-openshift-io-v1.md#buildrequest-build-openshift-io-v1) schema |
| 202 - Accepted | [`BuildRequest`](buildrequest-build-openshift-io-v1.md#buildrequest-build-openshift-io-v1) schema |
