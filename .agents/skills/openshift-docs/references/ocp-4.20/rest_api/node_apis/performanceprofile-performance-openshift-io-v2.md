...
| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`PerformanceProfileList`](../objects/index.md#io-openshift-performance-v2-PerformanceProfileList) schema |
| 401 - Unauthorized | Empty |
...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`PerformanceProfile`](performanceprofile-performance-openshift-io-v2.md#performanceprofile-performance-openshift-io-v2) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`PerformanceProfile`](performanceprofile-performance-openshift-io-v2.md#performanceprofile-performance-openshift-io-v2) schema |
| 201 - Created | [`PerformanceProfile`](performanceprofile-performance-openshift-io-v2.md#performanceprofile-performance-openshift-io-v2) schema |
| 202 - Accepted | [`PerformanceProfile`](performanceprofile-performance-openshift-io-v2.md#performanceprofile-performance-openshift-io-v2) schema |
| 401 - Unauthorized | Empty |
