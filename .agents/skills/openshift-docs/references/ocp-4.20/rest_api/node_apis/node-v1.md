...
<td style="text-align: left;"><p>TimeAdded represents the time at which the taint was added. It is only written for NoExecute taints.</p></td>
</tr>
<tr>
...
| Property | Type | Description |
|----|----|----|
| `lastHeartbeatTime` | [`Time`](../objects/index.md#io-k8s-apimachinery-pkg-apis-meta-v1-Time) | Last time we got an update on a given condition. |
...
| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`NodeList`](../objects/index.md#io-k8s-api-core-v1-NodeList) schema |
| 401 - Unauthorized | Empty |
...
| Parameter | Type                                              | Description |
|-----------|---------------------------------------------------|-------------|
| `body`    | [`Node`](node-v1.md#node-v1) schema |             |

Body parameters

| HTTP code          | Reponse body                                      |
|--------------------|---------------------------------------------------|
| 200 - OK           | [`Node`](node-v1.md#node-v1) schema |
| 201 - Created      | [`Node`](node-v1.md#node-v1) schema |
| 202 - Accepted     | [`Node`](node-v1.md#node-v1) schema |
| 401 - Unauthorized | Empty                                             |
