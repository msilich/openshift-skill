...
- [Introduction to OpenShift Container Platform](../../architecture/architecture.md#architecture-platform-introduction_architecture)

- [Using RBAC to define and apply permissions](../../authentication/using-rbac.md#using-rbac)

- [About admission plugins](../../architecture/admission-plug-ins.md#admission-plug-ins)
...
- [SCC reference commands](../../authentication/managing-security-context-constraints.md#security-context-constraints-command-reference_configuring-internal-oauth)

- [Examples of granting roles to service accounts](../../authentication/understanding-and-creating-service-accounts.md#service-accounts-granting-roles_understanding-service-accounts)
