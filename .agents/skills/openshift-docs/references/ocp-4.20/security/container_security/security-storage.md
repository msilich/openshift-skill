...
- [Configuring CSI volumes](../../storage/container_storage_interface/persistent-storage-csi.md#persistent-storage-using-csi)
...
- [Persistent storage using AWS Elastic Block Store](../../storage/persistent_storage/persistent-storage-aws.md#persistent-storage-using-aws-ebs)
