...
- [Creating a re-encrypt route with a custom certificate](../../networking/ingress_load_balancing/routes/creating-advanced-routes.md#nw-ingress-creating-a-reencrypt-route-with-a-custom-certificate_secured-routes)
