...
- [Preparing to install a cluster that uses SR-IOV or OVS-DPDK on OpenStack](../../installing/installing_openstack/installing-openstack-nfv-preparing.md#installing-openstack-nfv-preparing)
