...
- [Activating the control plane machine set custom resource](cpmso-getting-started.md#cpmso-activating_cpmso-getting-started)

- [Creating a control plane machine set custom resource](cpmso-getting-started.md#cpmso-creating-cr_cpmso-getting-started)
...
- [Sample Microsoft Azure provider specification](cpmso_provider_configurations/cpmso-config-options-azure.md#cpmso-yaml-provider-spec-azure_cpmso-config-options-azure)
