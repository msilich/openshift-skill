...
For clusters that include an inactive generated CR, you must review the CR configuration and [activate the CR](cpmso-getting-started.md#cpmso-activating_cpmso-getting-started).

Clusters without a generated CR
For clusters that do not include a generated CR, you must [create and activate a CR](cpmso-getting-started.md#cpmso-creating-cr_cpmso-getting-started) with the appropriate configuration for your cluster.

If you are uncertain about the state of the `ControlPlaneMachineSet` CR in your cluster, you can [verify the CR status](cpmso-getting-started.md#cpmso-checking-status_cpmso-getting-started).
...
2.  Google Cloud and Azure clusters that are upgraded from version 4.12 or earlier require [CR activation](cpmso-getting-started.md#cpmso-activating_cpmso-getting-started).

3.  Nutanix and RHOSP clusters that are upgraded from version 4.13 or earlier require [CR activation](cpmso-getting-started.md#cpmso-activating_cpmso-getting-started).

4.  vSphere clusters that are upgraded from version 4.15 or earlier require [CR activation](cpmso-getting-started.md#cpmso-activating_cpmso-getting-started).
...
- [Control plane machine set configuration](cpmso-configuration.md#cpmso-configuration)
...
- [Provider-specific configuration options](cpmso-configuration.md#cpmso-config-provider-specific_cpmso-configuration)
