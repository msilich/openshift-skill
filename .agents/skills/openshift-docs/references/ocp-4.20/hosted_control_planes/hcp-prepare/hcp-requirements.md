...
Learn about supported clusters, platforms, and architectures for hosted control planes, as well as information about updates and technology preview features.

Because the multicluster engine for Kubernetes Operator includes the HyperShift Operator, releases of hosted control planes align with releases of multicluster engine Operator. For more information, see "OpenShift Operator Life Cycles".
...
|----|----|----|----|----|----|
| 4.14 | Yes | Yes | Yes | No | No |
| 4.16 | Yes | Yes | Yes | Yes | No |
...
For example, if you have an OpenShift Container Platform 4.18 hosted cluster on the management cluster and you update multicluster engine Operator 2.8 to 2.9, the hosted cluster can continue to run.

## Technology Preview features

The following list indicates features in this release that have a Technology Preview status:

- Hosted control planes using non-bare-metal agent machines
...
- [The multicluster engine for Kubernetes operator 2.10 Support Matrix](https://access.redhat.com/articles/7133096)
