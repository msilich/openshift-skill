...
- [Persistent storage using LVM Storage](../../storage/persistent_storage_local/persistent-storage-using-lvms.md#persistent-storage-using-lvms_persistent-storage-using-lvms)
...
- [Adding hosts to the host inventory by using the Discovery Image](https://docs.redhat.com/en/documentation/red_hat_advanced_cluster_management_for_kubernetes/2.15/html/clusters/cluster_mce_overview#add-host-host-inventory)
