...
- [Installing the hosted control plane command-line interface](../hcp-prepare/hcp-cli.md#hcp-cli-terminal_hcp-cli)
...
- [Requirements for hosted control planes](../hcp-prepare/hcp-requirements.md#hcp-requirements)

- [DNS configurations on bare metal](hcp-deploy-bm.md#hcp-bm-dns_hcp-deploy-bm)
