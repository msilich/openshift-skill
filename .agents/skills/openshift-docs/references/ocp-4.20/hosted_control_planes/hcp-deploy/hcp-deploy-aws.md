...
- [Deploying the SR-IOV Operator for hosted control planes](../../networking/networking_operators/sr-iov-operator/configuring-sriov-operator.md#sriov-operator-hosted-control-planes_configuring-sriov-operator)
...
For more information about external DNS, see [external DNS](https://github.com/kubernetes-sigs/external-dns).
...
3.  To create a hosted cluster by using external DNS, enter the following command:
    ...
    `<ocp_release_image>`
    Specifies the supported OpenShift Container Platform version that you want to use, for example, `4.20.0-multi`.
...
- [Running hosted clusters on an ARM64 architecture](hcp-deploy-aws.md#hcp-enable-arm-amd_hcp-deploy-aws)
...
- [Creating an AWS IAM role and STS credentials](hcp-deploy-aws.md#hcp-aws-create-role-sts-creds_hcp-deploy-aws)
...
- [Enabling AWS PrivateLink for hosted control planes](hcp-deploy-aws.md#hcp-aws-enable-private-link_hcp-deploy-aws)

- [Creating an AWS IAM role and STS credentials](hcp-deploy-aws.md#hcp-aws-create-role-sts-creds_hcp-deploy-aws)

- [Identity and Access Management (IAM) permissions](../hcp-manage/hcp-manage-aws.md#hcp-manage-aws-infra-req_hcp-managing-aws)
