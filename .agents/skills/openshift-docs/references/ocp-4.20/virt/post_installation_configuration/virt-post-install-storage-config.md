...
- [Configuring storage profiles](../storage/virt-configuring-storage-profile.md#virt-configuring-storage-profile)

- [Storage configuration overview](../storage/virt-storage-config-overview.md#virt-storage-config-overview)
