...
- [Configuring a required node affinity rule](../../nodes/scheduling/nodes-scheduler-node-affinity.md#nodes-scheduler-node-affinity-configuring-required_nodes-scheduler-node-affinity)

- [About RHCOS](../../architecture/architecture-rhcos.md#rhcos-about_architecture-rhcos)

- [Optimizing storage](../../scalability_and_performance/optimization/optimizing-storage.md#_optimizing-storage)

- [Red Hat Ecosystem Catalog](https://catalog.redhat.com)

- [Configuring live migration](../live_migration/virt-configuring-live-migration.md#virt-configuring-live-migration)

- [Using a dedicated network for live migration](../vm_networking/virt-dedicated-network-live-migration.md#virt-dedicated-network-live-migration)
...
- [Installer-provisioned infrastructure installation overview](../../installing/installing_bare_metal/ipi/ipi-install-overview.md#ipi-install-overview)
