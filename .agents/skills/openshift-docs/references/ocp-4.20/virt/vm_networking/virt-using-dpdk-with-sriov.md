...
- [Using CPU Manager and Topology Manager](../../scalability_and_performance/using-cpu-manager.md#using-cpu-manager)

- [Optimizing memory management for workloads by using huge pages](../../scalability_and_performance/what-huge-pages-do-and-how-they-are-consumed-by-apps.md#what-huge-pages-do-and-how-they-are-consumed)

- [Creating a custom machine config pool](https://access.redhat.com/solutions/5688941)

- [Working with projects](../../applications/projects/working-with-projects.md#working-with-projects)
