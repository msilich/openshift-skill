...
> [!NOTE]
> Each minor version of OpenShift Virtualization is supported only with the corresponding OpenShift Container Platform version. For example, you must run OpenShift Virtualization 4.20 on OpenShift Container Platform 4.20.
...
- [Cluster service versions (CSVs)](../../operators/understanding/olm/olm-understanding-olm.md#olm-csv_olm-understanding-olm)
...
- [Configuring live migration limits and timeouts](../live_migration/virt-configuring-live-migration.md#virt-configuring-live-migration)
