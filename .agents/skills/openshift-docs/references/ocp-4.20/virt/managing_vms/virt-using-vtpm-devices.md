...
- [Exporting virtual machines](virt-exporting-vms.md#virt-exporting-vms)

- [Creating a snapshot by using the CLI](../backup_restore/virt-backup-restore-snapshots.md#virt-creating-vm-snapshot-cli_virt-backup-restore-snapshots)

- [Restoring a virtual machine from a snapshot by using the CLI](../backup_restore/virt-backup-restore-snapshots.md#virt-restoring-vm-from-snapshot-cli_virt-backup-restore-snapshots)
