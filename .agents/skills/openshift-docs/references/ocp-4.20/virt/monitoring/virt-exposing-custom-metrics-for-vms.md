...
- [Reviewing monitoring dashboards as a developer](https://docs.redhat.com/en/documentation/monitoring_stack_for_red_hat_openshift/4.20/html/accessing_metrics/accessing-metrics-as-a-developer#reviewing-monitoring-dashboards-developer_accessing-metrics-as-a-developer)

- [Monitoring application health by using health checks](../../applications/application-health.md#application-health)

- [Creating and using config maps](../../nodes/pods/nodes-pods-configmaps.md#nodes-pods-configmap-overview_configmaps)

- [Controlling virtual machine states](../managing_vms/virt-controlling-vm-states.md#virt-controlling-vm-states)
