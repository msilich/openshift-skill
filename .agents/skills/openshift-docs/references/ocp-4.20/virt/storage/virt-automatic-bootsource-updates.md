...
- [All Red Hat boot sources](virt-automatic-bootsource-updates.md#virt-managing-auto-update-all-system-boot-sources_virt-automatic-bootsource-updates)

- [All custom boot sources](virt-automatic-bootsource-updates.md#virt-autoupdate-custom-bootsource_virt-automatic-bootsource-updates)

- [Individual Red Hat or custom boot sources](virt-automatic-bootsource-updates.md#virt-disable-auto-updates-single-boot-source_virt-automatic-bootsource-updates)
