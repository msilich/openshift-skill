...
You can migrate your applications by using the Migration Toolkit for Containers (MTC) web console or the [command line](advanced-migration-options-mtc.md#migrating-applications-cli_advanced-migration-options-mtc).
...
- [MTC file system copy method](about-mtc.md#file-system-copy-method_about-mtc)

- [MTC snapshot copy method](about-mtc.md#snapshot-copy-method_about-mtc)
