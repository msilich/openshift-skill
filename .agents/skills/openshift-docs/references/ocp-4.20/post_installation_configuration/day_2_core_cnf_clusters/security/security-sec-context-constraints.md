...
For information about default security context constraints, see [Default security context constraints](../../../authentication/managing-security-context-constraints.md#default-sccs_configuring-internal-oauth).
...
>
> Instead of modifying the default SCCs, create and modify your own SCCs as needed. For detailed steps, see [Creating security context constraints](../../../authentication/managing-security-context-constraints.md#security-context-constraints-creating_configuring-internal-oauth).
...
For more information, see [Managing security context constraints](../../../authentication/managing-security-context-constraints.md).
