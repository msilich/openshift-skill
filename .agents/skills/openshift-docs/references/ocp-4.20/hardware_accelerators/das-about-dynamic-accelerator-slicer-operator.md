...
7.  In the OpenShift Container Platform web console, click **Ecosystem** → **Installed Operators**.
...
- [cert-manager Operator for Red Hat OpenShift](../security/cert_manager_operator/cert-manager-operator-install.md#cert-manager-operator-install)

- [Node Feature Discovery (NFD) Operator](../hardware_enablement/psap-node-feature-discovery-operator.md#psap-node-feature-discovery-operator)

- [NVIDIA GPU Operator](https://docs.nvidia.com/datacenter/cloud-native/openshift/latest/index.html)

- [NodeFeatureDiscovery CR](https://docs.redhat.com/en/documentation/openshift_container_platform/4.20/html/specialized_hardware_and_driver_enablement/psap-node-feature-discovery-operator#creating-nfd-cr-web-console_psap-node-feature-discovery-operator)
...
- [NodeFeatureDiscovery CR](https://docs.redhat.com/en/documentation/openshift_container_platform/4.20/html/specialized_hardware_and_driver_enablement/psap-node-feature-discovery-operator#creating-nfd-cr-cli_psap-node-feature-discovery-operator)
...
3.  Click the **Options** menu ![kebab](data:image/png;base64,) for the DAS Operator and select **Uninstall Operator**.
...
7.  Click the **Options** menu ![kebab](data:image/png;base64,) next to the das-operator project, and select **Delete Project**.
...
- [Node Feature Discovery Operator](../hardware_enablement/psap-node-feature-discovery-operator.md#psap-node-feature-discovery-operator)
