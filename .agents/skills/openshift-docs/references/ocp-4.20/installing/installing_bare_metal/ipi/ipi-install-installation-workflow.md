...
<figcaption aria-hidden="true">Configure networking</figcaption>
</figure>
...
<div id="additional-resources_bare_metal_config">
...
> [!NOTE]
> If you want to configure a hardware RAID for the node, verify that the node has a supported RAID controller. OpenShift Container Platform 4.20 does not support software RAID.
...
2.  Modify the `BareMetalHost` resource corresponding to the node:
    ...
    > [!NOTE]
    > The following example uses a hardware RAID configuration because OpenShift Container Platform 4.20 does not support software RAID.
...
<div id="additional-resources_raid_config">
