...
- [Preparing the bare-metal node](../bare-metal-expanding-the-cluster.md#preparing-the-bare-metal-node_bare-metal-expanding)

- [Root device hints](../ipi/ipi-install-installation-workflow.md#root-device-hints_ipi-install-installation-workflow)

- [Diagnosing a duplicate MAC address when provisioning a new host in the cluster](../bare-metal-expanding-the-cluster.md#ipi-install-diagnosing-duplicate-mac-address_bare-metal-expanding)
