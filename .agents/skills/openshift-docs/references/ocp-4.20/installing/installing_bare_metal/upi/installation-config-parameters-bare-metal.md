...
# Available installation configuration parameters for bare metal
...
- [OVN-Kubernetes IPv6 and dual-stack limitations](../../../networking/ovn_kubernetes_network_provider/about-ovn-kubernetes.md#nw-ovn-kubernetes-limitations_about-ovn-kubernetes)
