...
In OpenShift Container Platform version 4.17, you can install a cluster into an existing Virtual Private Cloud (VPC) on IBM Cloud®. The installation program provisions the rest of the required infrastructure, which you can then further customize. To customize the installation, you modify parameters in the `install-config.yaml` file before you install the cluster.
...
- You [configured an IBM Cloud® account](installing-ibm-cloud-account-power-vs.md#installing-ibm-cloud-account-power-vs) to host the cluster.
...
- You configured the `ccoctl` utility before you installed the cluster. For more information, see [Configuring the Cloud Credential Operator utility](preparing-to-install-on-ibm-power-vs.md#cco-ccoctl-configuring_preparing-to-install-on-ibm-power-vs).

# About using a custom VPC

In OpenShift Container Platform 4.17, you can deploy a cluster using an existing IBM® Virtual Private Cloud (VPC).
...
- [Installation configuration parameters for IBM Power® Virtual Server](installation-config-parameters-ibm-power-vs.md#installation-config-parameters-ibm-power-vs)
...
<div id="additional-resources_installing-ibm-powervs-vpc-console">
...
<div id="additional-resources_installing-ibm-powervs-vpc-telemetry">
...
- Optional: [Remote health reporting](../../support/remote_health_monitoring/remote-health-reporting.md#remote-health-reporting)
