...
- If the cloud identity and access management (IAM) APIs are not accessible in your environment, or if you do not want to store an administrator-level credential secret in the `kube-system` namespace, you have [manually created long-term credentials](../ipi/installing-azure-customizations.md#manually-create-iam_installing-azure-customizations).

- If you use customer-managed encryption keys, you [prepared your Azure environment for encryption](../ipi/installing-azure-preparing-ipi.md#preparing-disk-encryption-sets_installing-azure-preparing-ipi).
