...
- [Mirroring images for a disconnected installation](../../../disconnected/installing-mirroring-installation-images.md#installation-about-mirror-registry_installing-mirroring-installation-images)
...
- [Manually creating long-term credentials](../ipi/installing-azure-customizations.md#manually-create-iam_installing-azure-customizations)

- [Preparing your Azure environment for encryption](../ipi/installing-azure-preparing-ipi.md#preparing-disk-encryption-sets_installing-azure-preparing-ipi)
...
- [Configuring a public DNS zone in Azure](installing-restricted-networks-azure-user-provisioned.md#installation-azure-network-config_installing-restricted-networks-azure-user-provisioned)
...
``` json
link:https://raw.githubusercontent.com/openshift/installer/release-4.20/upi/azure/01_vnet.json[role=include]
```
...
``` json
link:https://raw.githubusercontent.com/openshift/installer/release-4.20/upi/azure/02_storage.json[role=include]
```
...
``` json
link:https://raw.githubusercontent.com/openshift/installer/release-4.20/upi/azure/03_infra.json[role=include]
```
...
``` json
link:https://raw.githubusercontent.com/openshift/installer/release-4.20/upi/azure/04_bootstrap.json[role=include]
```
...
``` json
link:https://raw.githubusercontent.com/openshift/installer/release-4.20/upi/azure/05_masters.json[role=include]
```
...
``` json
link:https://raw.githubusercontent.com/openshift/installer/release-4.20/upi/azure/06_workers.json[role=include]
```
