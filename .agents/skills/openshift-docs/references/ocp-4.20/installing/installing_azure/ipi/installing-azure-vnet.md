...
- To manage long-term cloud credentials manually, follow the procedure in [Manually creating long-term credentials](installing-azure-vnet.md#manually-create-iam_installing-azure-vnet).

- To implement short-term credentials that are managed outside the cluster for individual components, follow the procedures in [Configuring an Azure cluster to use short-term credentials](installing-azure-vnet.md#installing-azure-with-short-term-creds_installing-azure-vnet).
