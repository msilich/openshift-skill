...
In OpenShift Container Platform version 4.20, you can install a cluster directly in a logical partition (LPAR) on IBM Z® or IBM® LinuxONE infrastructure that you provision in a disconnected environment, without using a hypervisor layer.
...
- [Preparing to install a cluster on IBM Z using user-provisioned infrastructure](upi-ibm-z-preparing-to-install.md#upi-ibm-z-preparing-to-install)
