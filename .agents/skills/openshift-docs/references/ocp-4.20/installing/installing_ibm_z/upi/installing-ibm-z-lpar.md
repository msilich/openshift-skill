...
In OpenShift Container Platform version 4.20, you can install a cluster directly in a logical partition (LPAR) on IBM Z® or IBM® LinuxONE infrastructure that you provision, without using a hypervisor layer.
...
<table id="gatewayConfig-object_installing-ibm-z-lpar">
...
<table id="gatewayconfig-ipv4-object_installing-ibm-z-lpar">
...
<table id="gatewayconfig-ipv6-object_installing-ibm-z-lpar">
...
<table id="nw-operator-cr-ipsec_installing-ibm-z-lpar">
