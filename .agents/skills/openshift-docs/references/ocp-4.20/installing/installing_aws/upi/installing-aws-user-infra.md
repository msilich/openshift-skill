...
- You [prepared the user-provisioned infrastructure.](upi-aws-installation-reqs.md#upi-aws-installation-reqs)
...
- [RHCOS AMIs for the AWS infrastructure](installing-aws-user-infra.md#installation-aws-user-infra-rhcos-ami_installing-aws-user-infra)
...
- See [Monitoring installation progress](../../../support/troubleshooting/troubleshooting-installations.md#monitoring-installation-progress_troubleshooting-installations) for details about monitoring the installation, bootstrap, and control plane logs as an OpenShift Container Platform installation progresses.

- See [Gathering bootstrap node diagnostic data](../../../support/troubleshooting/troubleshooting-installations.md#gathering-bootstrap-diagnostic-data_troubleshooting-installations) for information about troubleshooting issues related to the bootstrap process.
