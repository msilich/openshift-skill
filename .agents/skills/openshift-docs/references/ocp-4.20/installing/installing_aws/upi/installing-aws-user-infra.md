...
To deploy OpenShift Container Platform version 4.20 on Amazon Web Services (AWS) with your own infrastructure, use the `CloudFormation` templates or create resources according to your company’s policies.
...
- [Preparing user-provisioned infrastructure](upi-aws-installation-reqs.md#upi-aws-installation-reqs)
...
- [RHCOS Amazon Machine Images (AMIs) for the AWS infrastructure](installing-aws-user-infra.md#installation-aws-user-infra-rhcos-ami_installing-aws-user-infra)
