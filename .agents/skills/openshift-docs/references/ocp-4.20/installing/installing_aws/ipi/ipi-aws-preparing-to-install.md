...
- [Manually creating long-term credentials](installing-aws-customizations.md#manually-create-iam_installing-aws-customizations)

- [Configuring an AWS cluster to use short-term credentials](installing-aws-customizations.md#installing-aws-with-short-term-creds_installing-aws-customizations)
