...
- If the cloud identity and access management (IAM) APIs are not accessible in your environment, or if you do not want to store an administrator-level credential secret in the `kube-system` namespace, [manually creating long-term credentials for AWS](installing-aws-customizations.md#manually-create-iam_installing-aws-customizations) or [configuring an AWS cluster to use short-term credentials](installing-aws-customizations.md#installing-aws-with-short-term-creds_installing-aws-customizations) with (AWS STS).
