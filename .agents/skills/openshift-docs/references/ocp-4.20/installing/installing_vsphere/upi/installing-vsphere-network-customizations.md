...
In OpenShift Container Platform version 4.20, you can install a cluster on VMware vSphere infrastructure that you provision with customized network configuration options. By customizing your network configuration, your cluster can coexist with existing IP address allocations in your environment and integrate with existing MTU and VXLAN configurations.
...
- [Adding compute machines to vSphere](../../../machine_management/user_infra/adding-vsphere-compute-user-infra.md#adding-vsphere-compute-user-infra)
...
- [Creating an encrypted storage class for encrypted virtual machines](../../../storage/container_storage_interface/persistent-storage-csi-vsphere.md#vsphere-pv-encryption)
