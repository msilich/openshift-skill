...
In OpenShift Container Platform version 4.20, you can install a customized cluster on IBM Cloud® by using installer-provisioned infrastructure. Change parameters in the `install-config.yaml` file before you install the cluster.
