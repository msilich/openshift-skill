...
- [Machine sets that deploy machines on ultra disks using CSI PVCs](../container_storage_interface/persistent-storage-csi-azure.md#machineset-azure-ultra-disk_persistent-storage-csi-azure)
