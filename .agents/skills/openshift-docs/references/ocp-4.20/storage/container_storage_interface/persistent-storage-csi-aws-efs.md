...
- [Installing the AWS EFS CSI Driver Operator](persistent-storage-csi-aws-efs.md#persistent-storage-csi-olm-operator-install_persistent-storage-csi-aws-efs)
...
- [Installing the AWS EFS CSI Driver](persistent-storage-csi-aws-efs.md#persistent-storage-csi-efs-driver-install_persistent-storage-csi-aws-efs)
...
## Enabling or disabling usage metrics using the web console
