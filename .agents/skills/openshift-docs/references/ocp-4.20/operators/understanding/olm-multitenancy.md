...
- [Common terms: Multitenant](olm-common-terms.md#olm-common-terms-multitenancy_olm-common-terms)

- [Limitations for multitenant Operator management](olm/olm-understanding-operatorgroups.md#olm-operatorgroups-limitations)
...
- [Adding Operators to a cluster](../admin/olm-adding-operators-to-cluster.md#olm-adding-operators-to-a-cluster)

- [Install modes types](olm/olm-understanding-operatorgroups.md#olm-operatorgroups-membership_olm-understanding-operatorgroups)
...
- [Preparing for multiple instances of an Operator for multitenant clusters](../admin/olm-adding-operators-to-cluster.md#olm-preparing-operators-multitenant_olm-adding-operators-to-a-cluster)
