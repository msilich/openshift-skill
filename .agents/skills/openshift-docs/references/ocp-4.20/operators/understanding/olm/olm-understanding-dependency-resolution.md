...
- [Common Expression Language (CEL) constraints](olm-understanding-dependency-resolution.md#olm-cel_olm-understanding-dependency-resolution)
...
- [Catalog health requirements](olm-understanding-olm.md#olm-cs-health_olm-understanding-olm)
