...
- [Installing global Operators in custom namespaces](../../admin/olm-adding-operators-to-cluster.md#olm-installing-global-namespaces_olm-adding-operators-to-a-cluster)

- [Operators in multitenant clusters](../olm-multitenancy.md#olm-multitenancy)
