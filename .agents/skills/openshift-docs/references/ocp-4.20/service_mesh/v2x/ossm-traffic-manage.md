...
For more information, see "Using wildcard routes" in [Ingress Operator in OpenShift Container Platform](../../networking/networking_operators/ingress-operator.md#using-wildcard-routes).
...
- [Route-specific annotations](../../networking/ingress_load_balancing/routes/nw-configuring-routes.md#nw-route-specific-annotations).
...
This guide references the Bookinfo sample application to provide examples of routing in an example application. Install the [Bookinfo application](prepare-to-deploy-applications-ossm.md#ossm-tutorial-bookinfo-overview_ossm-create-mesh) to learn how these routing examples work.
