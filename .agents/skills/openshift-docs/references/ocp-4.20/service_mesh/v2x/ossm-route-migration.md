...
- [Creating an HTTP-based Route](../../networking/ingress_load_balancing/routes/creating-basic-routes.md#nw-creating-a-route_route-configuration)

- [Understanding automatic routes](ossm-traffic-manage.md#ossm-auto-route_traffic-management)
