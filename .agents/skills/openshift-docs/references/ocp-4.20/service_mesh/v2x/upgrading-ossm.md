...
To access the most current features of Red Hat OpenShift Service Mesh, upgrade to the current version, 2.6.12.
...
For more information about upgrading Operators, refer to the [Operator Lifecycle Manager](../../operators/admin/olm-upgrading-operators.md) documentation.
...
For more information about migrating your extensions, refer to [Migrating from ServiceMeshExtension to WasmPlugin resources](ossm-extensions.md#ossm-extensions-migration-overview_ossm-extensions).
...
<div id="ossm-upgrading-differences-behavior_ossm-upgrade">
...
For information about mTLS, see [Enabling mutual Transport Layer Security (mTLS)](ossm-security.md#ossm-security-mtls_ossm-security)
...
Some components support resource limiting and scheduling. For more information, see [Performance and scalability](ossm-performance-scalability.md#ossm-performance-scalability).
