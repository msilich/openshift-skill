...
- [Using PolicyGenerator CRs to override source CRs content](ztp-advanced-policygenerator-config.md#ztp-using-pgt-to-update-source-crs_ztp-advanced-policygenerator-config)
