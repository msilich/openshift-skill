...
- [Signalling GitOps ZTP cluster deployment completion with validator inform policies](ztp-advanced-policygenerator-config.md#ztp-creating-a-validator-inform-policy_ztp-advanced-policy-config)
...
- [Customizing a managed cluster with PolicyGenerator CRs](ztp-configuring-managed-clusters-policygenerator.md#ztp-customizing-a-managed-site-using-pgt_ztp-configuring-managed-clusters-policygenerator)
...
- For information about using Topology Aware Lifecycle Manager (TALM) to construct your own `ClusterGroupUpgrade` CR, see [About the ClusterGroupUpgrade CR](../cnf-talm-for-cluster-upgrades.md#talo-about-cgu-crs_cnf-topology-aware-lifecycle-manager).
