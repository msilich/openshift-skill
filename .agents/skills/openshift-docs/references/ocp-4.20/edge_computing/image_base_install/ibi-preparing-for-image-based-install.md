...
- [Software prerequisites for an image-based installation and deployment](ibi-understanding-image-based-install.md#ztp-image-based-upgrade-prereqs_ibi-understanding-image-based-install)
