...
- [Enabling the assisted service](ztp-preparing-the-hub-cluster.md#enabling-assisted-installer-service-on-bare-metal_ztp-preparing-the-hub-cluster)
...
- [About the Topology Aware Lifecycle Manager configuration](cnf-talm-for-cluster-upgrades.md#cnf-about-topology-aware-lifecycle-manager-config_cnf-topology-aware-lifecycle-manager)

- [About the auto-created ClusterGroupUpgrade CR for GitOps ZTP](policygentemplate_for_ztp/ztp-talm-updating-managed-policies.md#talo-precache-autocreated-cgu-for-ztp_ztp-talm)
