...
- [Installing and configuring the OADP Operator with GitOps ZTP](cnf-image-based-upgrade-install-operators.md#ztp-image-based-upgrade-installing-oadp_install-operators)
...
- [Performing an image-based upgrade for single-node OpenShift clusters using GitOps ZTP](../ztp-image-based-upgrade.md#ztp-image-based-upgrade)
