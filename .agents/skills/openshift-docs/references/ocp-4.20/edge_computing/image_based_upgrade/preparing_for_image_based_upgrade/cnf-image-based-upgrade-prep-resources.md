...
- [Catalog source](../../../operators/understanding/olm/olm-understanding-olm.md#olm-catalogsource_olm-understanding-olm)

- [Performing an image-based upgrade for single-node OpenShift with Lifecycle Agent](../cnf-image-based-upgrade-base.md#cnf-image-based-upgrade)
