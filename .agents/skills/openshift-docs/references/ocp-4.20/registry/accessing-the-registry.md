...
- [Allowing pods to reference images across projects](../openshift_images/managing_images/using-image-pull-secrets.md#images-allow-pods-to-reference-images-across-projects_using-image-pull-secrets)

- [Removing the kubeadmin user](../authentication/remove-kubeadmin.md#removing-kubeadmin_removing-kubeadmin)

- [Understanding identity provider configuration](../authentication/understanding-identity-provider.md#understanding-identity-provider_understanding-identity-provider)
