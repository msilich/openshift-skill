...
- [Expanding the cluster](../installing/installing_bare_metal/bare-metal-expanding-the-cluster.md#bare-metal-expanding-the-cluster)

- [MachineHealthChecks on bare metal](../machine_management/deploying-machine-health-checks.md#machine-health-checks-bare-metal_deploying-machine-health-checks)
