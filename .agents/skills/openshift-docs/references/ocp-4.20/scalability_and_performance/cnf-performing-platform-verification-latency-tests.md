...
- [Scheduling a workload onto a worker with real-time capabilities](cnf-provisioning-low-latency-workloads.md#cnf-scheduling-workload-onto-worker-with-real-time-capabilities_cnf-provisioning-low-latency)
