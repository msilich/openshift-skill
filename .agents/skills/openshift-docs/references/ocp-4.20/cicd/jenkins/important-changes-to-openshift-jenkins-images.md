...
These changes support the OpenShift Container Platform 4.10 recommendation to use [multiple container Pod Templates with the Jenkins Kubernetes Plugin](images-other-jenkins.md#images-other-jenkins-config-kubernetes_images-other-jenkins).
...
- [Adding tags to image streams](../../openshift_images/managing_images/tagging-images.md#images-add-tags-to-imagestreams_tagging-images)

- [Configuring periodic importing of image stream tags](../../openshift_images/image-streams-manage.md#images-imagestream-import_image-streams-managing)

- [Jenkins agent](images-other-jenkins-agent.md#images-other-jenkins-agent)
