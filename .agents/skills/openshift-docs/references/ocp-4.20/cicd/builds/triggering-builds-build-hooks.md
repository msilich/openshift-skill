...
- [Cluster role bindings for unauthenticated groups](../../authentication/using-rbac.md#unauthenticated-users-cluster-role-bindings-concept_using-rbac)

- [Webhook admission plugins](../../architecture/admission-plug-ins.md#admission-webhooks-about_admission-plug-ins)
...
- Use one of the following options to configure post-build hooks:
  ...
  <span id="cb3-3"><a href="#cb3-3" aria-hidden="true" tabindex="-1"></a><span class="at">  </span><span class="fu">args</span><span class="kw">:</span><span class="at"> </span><span class="kw">[</span><span class="st">&quot;--verbose&quot;</span><span class="kw">]</span></span></code></pre></div>
  <p>This form is equivalent to appending the arguments to <code>command</code>.</p></td>
  </tr>
  </tbody>
  </table>
