...
For more information, see [Operator Controller](arch/operator-controller.md#operator-controller) and [Catalogd](arch/catalogd.md#catalogd).

Improved control over extension updates
With improved insight into catalog content, administrators can specify target versions for installation and updates. This grants administrators more control over the target version of extension updates. For more information, see [Updating an cluster extension](ce/managing-ce.md#olmv1-updating-an-operator_managing-ce).
...
In addition, bundle size is no longer constrained by the etcd value size limit. For more information, see [Installing extensions](ce/managing-ce.md#managing-ce).
