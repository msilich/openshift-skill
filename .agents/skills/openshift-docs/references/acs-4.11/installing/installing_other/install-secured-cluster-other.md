...
<a id="installing-sc-helm-other_install-secured-cluster-other"></a>
...
<a id="installing-sc-helm-default-other_install-secured-cluster-other"></a>
...
<a id="adding-helm-repository_install-secured-cluster-other"></a>
...
<a id="installing-secured-cluster-services-quickly_install-secured-cluster-other"></a>
...
- [Generating and applying a cluster registration secret or init bundle for RHACS on other platforms](init-bundle-other.md)

</div>

<a id="configure-secured-cluster-services-helm-chart-customizations-other_install-secured-cluster-other"></a>
...
<a id="secured-cluster-services-config_install-secured-cluster-other"></a>
...
<a id="install-secured-cluster-services-helm-chart_install-secured-cluster-other"></a>
...
- [Generating and applying a cluster registration secret or an init bundle for RHACS on other platforms](init-bundle-other.md)

</div>

<a id="change-config-options-after-deployment_install-secured-cluster-other"></a>
...
<a id="installing-sc-roxctl-sc-other_install-secured-cluster-other"></a>

# Install RHACS on secured clusters by using the roxctl CLI
...
<a id="installing-roxctl-cli-ocp_install-secured-cluster-other"></a>
...
<a id="installing-cli-on-linux_install-secured-cluster-other"></a>
...
<a id="installing-cli-on-macos_install-secured-cluster-other"></a>
...
<a id="installing-cli-on-windows_install-secured-cluster-other"></a>
...
<a id="install-sensor-roxctl_install-secured-cluster-other"></a>
...
<a id="installing-manifest-web-portal_install-secured-cluster-other"></a>
...
<a id="manifest-roxctl_install-secured-cluster-other"></a>
