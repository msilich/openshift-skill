...
Central handles data persistence, API interactions, and RHACS portal access. You can install Central services on other platforms by using Helm charts or by using the `roxctl` CLI.

<a id="install-central-other-overview_install-central-other"></a>
...
<a id="install-using-helm-no-customizations-other_install-central-other"></a>
...
<a id="install-central-using-helm-charts-without-customization-other_install-central-other"></a>

## Install Central by using Helm charts without customization

You can install Red Hat Advanced Cluster Security for Kubernetes (RHACS) on your cluster without any customizations. You must add the Helm chart repository and install the `central-services` Helm chart to install the centralized components of Central and Scanner.

<a id="adding-helm-repository_install-central-other"></a>
...
<a id="installing-quickly_install-central-other"></a>
...
<a id="automatically-generated-ca_install-central-other"></a>
...
<a id="install-using-helm-customizations-other_install-central-other"></a>

## Install Central by using Helm charts with customizations

You can install RHACS on your cluster with customizations by using Helm chart configuration parameters with the `helm install` and `helm upgrade` commands. You can specify these parameters by using the `--set` option or by creating YAML configuration files.
...
<a id="central-services-private-configuration-file_install-central-other"></a>
...
<a id="central-services-private-configuration-file-image-pull-secrets_install-central-other"></a>
...
<a id="central-services-private-configuration-file-proxy-config_install-central-other"></a>
...
<a id="central-services-private-configuration-file-central_install-central-other"></a>
...
<a id="central-services-private-configuration-file-scanner_install-central-other"></a>
...
<a id="central-services-public-configuration-file_install-central-other"></a>

### Public configuration file

The `values-public.yaml` file has configurable parameters for the installation.

<a id="central-services-public-configuration-file-image-pull-secrets_install-central-other"></a>
...
<a id="central-services-public-configuration-file-image_install-central-other"></a>
...
<a id="central-services-public-configuration-file-config-as-code_install-central-other"></a>
...
<a id="central-services-public-configuration-file-environment-variables_install-central-other"></a>
...
<a id="additional-trusted-certificate-authorities_install-central-other"></a>
...
<a id="default-network-policy-creation_install-central-other"></a>
...
<a id="central-services-public-configuration-file-central_install-central-other"></a>
...
<a id="central-services-public-configuration-file-scanner_install-central-other"></a>
...
<a id="central-services-public-configuration-file-scannerv4_install-central-other"></a>
...
<a id="central-services-public-configuration-file-customizations_install-central-other"></a>
...
<a id="central-services-public-configuration-file-advance-customization_install-central-other"></a>
...
<a id="declarative-configuration-values_install-central-other"></a>
...
<a id="install-central-services-helm-chart_install-central-other"></a>
...
<a id="change-config-options-after-deployment-central-services_install-central-other"></a>
...
<a id="install-using-roxctl-other_install-central-other"></a>

# Install Central by using the roxctl CLI

For production environments, Red Hat recommends using Helm charts to install RHACS.

> [!WARNING]
> Do not use the `roxctl` install method unless you have a specific installation need that requires using this method.

<a id="installing-roxctl-cli-other_install-central-other"></a>
...
<a id="installing-cli-on-linux_install-central-other"></a>
...
<a id="installing-cli-on-macos_install-central-other"></a>
...
<a id="installing-cli-on-windows_install-central-other"></a>
...
<a id="using-the-interactive-installer_install-central-other"></a>
...
<a id="install-central-roxctl_install-central-other"></a>
