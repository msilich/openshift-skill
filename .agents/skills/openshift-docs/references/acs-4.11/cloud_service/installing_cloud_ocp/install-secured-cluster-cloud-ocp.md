...
<a id="install-secured-cluster-cloud-ocp-prerequisites_install-secured-cluster-cloud-ocp"></a>

# Prerequisites

Many of the tasks associated with installing secured cluster resources from RHACS Cloud Service have the following prerequisites:

- During RHACS installation, you noted the **Central instance** address. You can view this information by choosing **Advanced Cluster Security** → **ACS Instances** from the Red Hat Hybrid Cloud Console navigation menu, and then clicking the ACS instance you created.
...
<a id="installing-sc-operator-cloud-ocp_install-secured-cluster-cloud-ocp"></a>
...
<a id="install-acs-operator-annotations_install-secured-cluster-cloud-ocp"></a>
...
<a id="install-secured-cluster-operator_install-secured-cluster-cloud-ocp"></a>
...
<a id="installing-sc-helm-cloud-ocp_install-secured-cluster-cloud-ocp"></a>

# Installing RHACS Cloud Service on secured clusters by using Helm charts

You can install RHACS on secured clusters by using Helm charts with no customization of the default values or with customization of configuration parameters.

<a id="adding-helm-repository_install-secured-cluster-cloud-ocp"></a>
...
<a id="installing-sc-helm-default-cloud-ocp_install-secured-cluster-cloud-ocp"></a>
...
<a id="installing-secured-cluster-services-quickly_install-secured-cluster-cloud-ocp"></a>
...
- [Generating a cluster registration secret or an init bundle for secured clusters](init-bundle-cloud-ocp-generate.md)

- [Applying a cluster registration secret or an init bundle for secured clusters](init-bundle-cloud-ocp-apply.md)

</div>

<a id="configure-secured-cluster-services-helm-chart-customizations-cloud-ocp_install-secured-cluster-cloud-ocp"></a>
...
<a id="secured-cluster-services-config_install-secured-cluster-cloud-ocp"></a>
...
<a id="install-secured-cluster-services-helm-chart_install-secured-cluster-cloud-ocp"></a>
...
<a id="change-config-options-after-deployment_install-secured-cluster-cloud-ocp"></a>
...
<a id="installing-sc-roxctl-cloud-ocp_install-secured-cluster-cloud-ocp"></a>
...
<a id="installing-roxctl-cli-sc-cloud-ocp_install-secured-cluster-cloud-ocp"></a>

## Installing the roxctl CLI

You must first download the binary. You can install `roxctl` on Linux, Windows, or macOS.

<a id="installing-cli-on-linux_install-secured-cluster-cloud-ocp"></a>
...
<a id="installing-cli-on-macos_install-secured-cluster-cloud-ocp"></a>
...
<a id="installing-cli-on-windows_install-secured-cluster-cloud-ocp"></a>
...
<a id="install-sensor-roxctl_install-secured-cluster-cloud-ocp"></a>
...
<a id="next-steps_install-secured-cluster-cloud-ocp"></a>

# Next steps

After installing RHACS Cloud Service on your secured clusters, verify the installation to ensure proper communication with the ACS instance.
...
- [Verify installation](verify-installation-cloud-ocp.md)
