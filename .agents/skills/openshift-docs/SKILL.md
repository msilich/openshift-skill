...
- The snapshots cover OCP 4.22, GitOps 1.21 and Dev Spaces 3.29. State the limitation for another requested version. Bundling them together does not certify product compatibility.
