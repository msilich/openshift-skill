...
- `openshift-docs` — a complete, searchable, offline OpenShift Container
  Platform 4.20, OpenShift GitOps 1.21, Dev Spaces 3.29 and RHACS 4.11 documentation snapshots.
...
| `.agents/skills/openshift-docs/` | Offline OCP 4.20, GitOps 1.21, Dev Spaces 3.29 and RHACS 4.11 documentation skill |
